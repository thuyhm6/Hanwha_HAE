...
@Controller
@RequestMapping(value = "/report/pac07")
public class PaReportC07Ctroller extends SqlMapClientSupport {
	@Autowired
	...
	public void exportDatilyReport2(HttpServletRequest request,
		...
		String reportName = StringUtil.checkNull(request.getParameter("reportName"));
		String suffix = StringUtil.checkNull(request.getParameter("suffix").toLowerCase());
		if("211811".equals(JOB_TP)||"211816".equals(JOB_TP)||
				"211818".equals(JOB_TP)||"211813".equals(JOB_TP)||"211817".equals(JOB_TP)){
	          reportName="payRetrieveGuLiListLGECH";
		}else if("211812".equals(JOB_TP)){
	  			reportName="payRetrieveSalesmanDetailListadd";
		}else if("211814".equals(JOB_TP)){
					reportName="payPayDetailListPromtradd";
		}else {                
			  reportName="payPayDetailListLGECH";
		}
		if (!reportName.equals("") && !suffix.equals("")) {
  			String reportId = reportName;
