...
@Component
public class SelectDeptTreeTag1 extends RequestContextAwareTag {
	...
	public int doStartTagInternal() throws JspException {
		...
		try {
			...
			scriptStr.append("<div id=\"deptContent_" + sysLong + "\" style=\"display:none; position: absolute;z-index:100;overflow:yes;height:350px; border:solid 1px #CCC; line-height:21px; background:#FFF;\" >");
