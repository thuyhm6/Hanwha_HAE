...
@Component
public class CheckBoxTreeTableByCpnyIDTag extends RequestContextAwareTag {
	...
	public int doStartTagInternal() throws JspException {
		...
		tableName = eval("tableName", tableName, Object.class).toString();
	...
	//    codeList = informationRetrievalDao.getCodeParamList(paramMap);
		...
		try {
			...
			// ajax
			scriptStr.append(" function createCodeTree_"+tableName+"(table_name) ");
			scriptStr.append("  {   ");
			...
			scriptStr.append("     url:'/hrm/informationRetrieval/getTableCodeParamList?TABLE_NAME='+table_name,  ");  
	...
	*/	   
         ...
         //生成INPUT和隐藏div
           ...
           scriptStr.append("<input id=\""+ name + "\" type=\"text\" onclick=\"createCodeTree_"+tableName+"('"+tableName+"')\" readonly  />");
