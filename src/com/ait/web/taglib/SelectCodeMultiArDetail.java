...
@Component
public class SelectCodeMultiArDetail extends RequestContextAwareTag {
	...
	public int doStartTagInternal() throws JspException {
		...
		List codeList = hrmDao.getDeptTree("pa.workManagement.getSelectCodeMultiArDetailList",paramMap);
		...
		try {
			...
			scriptStr.append("<ul id=\"deptTree_" + sysLong + "\" class=\"ztree\" style=\"margin-top:0;height:250px; width:300px;overflow:auto\"></ul>");
