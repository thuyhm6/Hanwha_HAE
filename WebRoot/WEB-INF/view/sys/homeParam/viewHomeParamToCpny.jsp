...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" id="editButton" href="/sys/homeParam/updateHomeParamCpnyView?PARAM_NO={sid}" target="dialog" mask="true" width="600" height="500" ><span>
			<spring:message code="sys.homeParam.title.updatePrivilege"/><!--修改权限--></span></a></li>
