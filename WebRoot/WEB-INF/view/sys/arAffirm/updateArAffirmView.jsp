...
function validateCallbackSy0481_update(form, callback) {
...
<div class="pageContent">
	<form method="post" action="/sys/arAffirm/updateArAffirmInfo" class="pageForm required-validate" 
	      onsubmit="return validateCallbackSy0481_update(this,navTabAjaxDone);">
		<div class="formBar">
				<ul>
