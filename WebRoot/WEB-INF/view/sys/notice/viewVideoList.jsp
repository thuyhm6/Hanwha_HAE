...
$(document).ready(function(){
	$("#viewVideoList_seach",navTab.getCurrentPanel()).click(function(){
		$("#viewVideoListForm",navTab.getCurrentPanel()).submit();
	});
});
...
<form id="viewVideoListForm" onsubmit="return navTabSearch(this);" action="/sys/notice/viewVideoList" method="post">
<div class="searchBar">
...
<div class="formBar">
	<ul class="toolBar">
			<li>
				<a class="buttonActive" id="viewVideoList_seach" href="#">
					<span style="margin-left:-0px"><!--查询 --><spring:message code="ess.infoApply.SELECT"/></span>
				</a>
			</li>
			<li>
				<a class="buttonActive" onclick="downloadExcel('viewVideoListForm','/disc/autoExcel/exportLOtImportExcel?SQL_SEQMEAN=159','/sys/notice/viewVideoList?firstFlag=N')">
...
<div class="pageContent" style="padding-left:10px;padding-right:10px;">
		...
		<td class="td_title" width="15%">View time</td>
		</tr>
		<c:forEach items="${getVideoList}" var="d" varStatus="i">
		<tr>
		...
		<td class="td_type">${d.VIEW_DATE }</td>
		</tr>
		</c:forEach>
		</table>
