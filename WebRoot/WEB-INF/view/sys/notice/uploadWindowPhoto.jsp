...
<div class="pageContent" layoutH="10">
	<form id="uploadWindowForm" method="post" action="/sys/notice/uploadAttPhoto" class="pageForm required-validate" onsubmit="return validateCallbackuploadWindow(this, dialogAjaxDone)">
				 ...
				 <input id="testFileInput_upload"
					type="file" name="file"
					 uploaderOption="{
					    ...
					    uploader:'/ess/infoApplyLeave/uploadBatchPhoto?PERSON_ID=${LoginUser.personId}',
						formData:{ajax:1},
