...
<SCRIPT type='text/javascript'>
		...
		function addTdAdd_sy0130_update(personId,empId,empName,deptName,letters){
		   var rowNum=document.getElementById('empTb').rows.length;
		   	...
		   	if(keyCode==13){
				...
				if(empid == ''){
					...
					document.getElementById("onck").href=encodeURI(encodeURI("/sys/affirm/viewAffirmorsList?pageNum=1&navTabId=" + navTabId + "&seach_EMPID="
							...
							+idcardNo
							+'&empId_sy0130_update='+empIdStr
							+'&personId_sy0130_update='+personIdStr
							));
			   		...
			   		$.ajax({
						...
						success: function(jsonObject){
									...
									if(jsonObject.perCnt==1){
										...
										addTdAdd_sy0130_update(jsonObject.personId,jsonObject.empId,jsonObject.empName,jsonObject.deptName,"");
									}
								},
						error: DWZ.ajaxError
					});
	...
	//	}
	function validateCallbackSy0130_update(form, callback) {
...
<div class="pageContent">
	<form method="post" action="/sys/affirm/insertAffirmInfo" class="pageForm required-validate" onsubmit="return validateCallbackSy0130_update(this,navTabAjaxDone);">
			...
			<dl>
				...
				<dd> 
					<div>
						...
						<input id="EMPID"  name="EMP_ID" type="text" value="" size="30" alt="请输入关键字按回车检索" onkeydown="submitKeyClick_sy0130_update(this,'','','${param.navTabId}',event)" />
				...
				<dl>
					...
					<dd>
							<table border=1 width="600" id="empTb"  class="user_table">
									...
									<c:forEach items="${affirmorList}" var="employee" varStatus="i">
										<tr  height="25">
