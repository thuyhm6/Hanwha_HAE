...
<div class="pageHeader">
	<form method="post" action="/sys/affirmSpecial/viewAffirmorsSpecialList?navTabId=${param.navTabId}" onsubmit="return dwzSearch(this,'dialog')" rel="pagerForm">
	...
	<div class="searchBar" >
		<table class="searchContent">
			<tr>
				...
				<td>
					<ait:deptList name="seach_DEPTNO" limit="hr" id="deptName_sy0010sp_add_0_viewAffirmorsSpecial"/>
					<ait:deptTreeIcon name="seach_DEPTNO" limit="hr" id="deptName_sy0010sp_add_0_viewAffirmorsSpecial" selected="${DEPTNO}"/>
				</td>
			</tr>
		</table>
		<div class="subBar">
...
<div class="pageContent">
	<table class="table" width="100%" layoutH="138">
		...
		var initVar=1;
		function checkTrAffirmorsSpecial(personId,empId,localName,deptName,letter){
			var personIdStr="btnSelect1"+personId;
			if(initVar==1){
				checkAffirmorSpecial(personId,empId,localName,deptName,letter);
				initVar=initVar+1;
			...
			<c:forEach items="${empList}" var="item">
				<tr target="EMPID" rel="${item.EMPID}" onclick="checkTrAffirmorsSpecial('${item.PERSON_ID}','${item.EMPID}','${item.LOCAL_NAME}','${item.DEPTNAME}','');">
				    <td>
						<a class="checkBox" id="btnSelect1${item.PERSON_ID}" 
						href="javascript:
	...
	<form id="pagerForm" method="post" action="/sys/affirmSpecial/viewAffirmorsSpecialList?navTabId=${param.navTabId}">
	<div class="panelBar">
		<div class="pages">
