...
<div class="pageContent" layoutH="10">
	<form id="uploadWindowForm" method="post"
		action="/sys/notice/uploadAtt" class="pageForm required-validate"
		onsubmit="return validateCallbackuploadWindow(this, dialogAjaxDone)">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td class="td_type" colspan="1">
						<input id="testFileInput_upload" type="file" name="file"
							uploaderOption="{
						...
						<div class="buttonActive">
							<div class="buttonContent">
								...
								<button type="button"
									...
									<spring:message code="hrm.empinfo.upload"/><!-- 上传 -->
								</button>
							</div>
						</div>
						<div class="buttonActive">
							<div class="buttonContent">
								...
								<button type="button"
									...
									<spring:message code="hrm.empinfo.cancel"/><!-- 取消 -->
								</button>
							</div>
						</div>
					</td>
