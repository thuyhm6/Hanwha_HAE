...
function quanXuan(){
	...
	var ids= document.getElementsByName("SELECTR");
	...
	var ids= document.getElementsByName("INSERTR");
	...
	var ids= document.getElementsByName("UPDATER");
	...
	var ids= document.getElementsByName("DELETER");
						...
						<table class="table" width="99%" layoutH="160">
							...
							<c:forEach items="${subMenuLists}" var="menu" varStatus="i">
								<tr target="CodeNO" rel="${menu.MENU_NO}" id="TR${menu.MENU_NO}">
									...
									<td>${ menu.CONTENT}</td>
									<td><input type="checkbox" value="${menu.MENU_NO}" id="SELECTR" name="SELECTR" onclick="choseVale(this,${menu.MENU_NO});"> </input></td>
									<td><input type="checkbox" value="${menu.MENU_NO}" id="INSERTR" name="INSERTR" onclick="choseVale(this,${menu.MENU_NO});"> </input></td>
									<td><input type="checkbox" value="${menu.MENU_NO}" id="UPDATER" name="UPDATER" onclick="choseVale(this,${menu.MENU_NO});"> </input></td>
									<td><input type="checkbox" value="${menu.MENU_NO}" id="DELETER" name="DELETER" onclick="choseVale(this,${menu.MENU_NO});"> </input></td>
								</tr>
							</c:forEach>`
							</tbody>
						</table>
