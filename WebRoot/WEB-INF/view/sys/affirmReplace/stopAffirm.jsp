...
<div class="pageContent">
	<form id="addStopAffirm" name="addStopAffirm" method="post" class="pageForm required-validate" 
		action="/sys/affirmReplace/addStopAffirm" onsubmit="return validateCallback_insertSqlMaster(this, dialogAjaxDone);">
		<div class="pageFormContent nowrap" layoutH="90">
			...
			<dl>
				...
				<dd>
					<c:out value='终止'/>  
					<input name="REPLACE_TYPE" type="hidden" readonly="true" size="18" value="<c:out value='ZZ'/>">
				</dd>
			...
			<dl>
				...
				<dd>
					<input id="OLDCHECK_NM" name="dwz.person.empNameold" type="text" readonly value=""  lookupGroup="person"/>
					...
					<input type="hidden" id="NEWCHECK_PERSONID" name="dwz.person.person_idnew" value=""> 
				</dd>
			</dl>
			<!--  <dl>
				<dt>
				...
				<dd>
					...
					<input type="text" id="NEWCHECK_PERSONID" name="dwz.person.person_idnew"  value="${NEWCHECK_PERSONID}" readOnly lookupGroup="person"/>
