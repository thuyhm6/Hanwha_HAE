...
<div class="pageContent">
	<form method="post" action="/sys/postManagement/addPositionInfo" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
				...
				<dd>
					<select name="POST_CATEGORY_NO">
				 		<c:forEach items="${gategoryList}" var="gategory">
							<option value="${gategory.CODE_NO}">${gategory.CODE_NAME}</option>
						</c:forEach>
					</select>
				</dd>
			</dl>
