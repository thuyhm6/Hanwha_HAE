...
<body>
<form id="addMacAffirmInfo" method="post" action="/LGEP/affirm/affirmCwaAbnormal" class="pageForm required-validate" onsubmit="return validateContractAffirmCallback(this,navTabAjaxDone);">
									...
									<tr id="${affirmor.AFFIRMOR_ID }_${j.index}">
										...
										<td class="td_type" style="text-align: center">
											...
											<img id="${affirmor.AFFIRMOR_ID}" src="/resources/images/+.gif" title="添加Check"
												border="0" align="absmiddle" style="cursor:hand" onclick="addCheck('218197','${affirmor.ESS_AFFIRM_NO}','${affirmor.AFFIRMOR_ID}')"/>
											</c:if>
										</td>
									</tr>			
								</c:forEach>
