...
<div class="pageContent">
	<form id="viewFullApplyRemarkInfo" method="post" action="/ess/affirmApply/addApplyCheckList" class="pageForm required-validate" 
			...
			<dl>
				...
				<dd>
					<input id="APPLY_NO" name="APPLY_NO" value="${APPLY_NO }" type="hidden"/>
							 ...
							 <input id="OT_TIME_TYPE_FLAG" name="OT_TIME_TYPE_FLAG" value="${OT_TIME_TYPE}" type="hidden"/>
