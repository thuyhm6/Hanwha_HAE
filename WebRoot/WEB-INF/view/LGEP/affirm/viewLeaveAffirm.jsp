...
<body>
	<form id="addLeaveAffirmInfo" method="post" action="/LGEP/affirm/affirmLeave" class="pageForm required-validate" onsubmit="return validateContractAffirmCallback(this,navTabAjaxDone);">
