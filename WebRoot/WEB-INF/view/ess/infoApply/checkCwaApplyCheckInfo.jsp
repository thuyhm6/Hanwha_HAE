...
<div class="pageContent" >
	<form id="checkApplyInfo" method="post" action="/ess/affirmLeaveApply/checkCwaApplyInfo" class="pageForm required-validate" 
		onsubmit="return validateCallback(this, dialogAjaxDone)">
		<table class="user_table" width="100%" layoutH="60">
				<tr>
					<td colspan="8">
