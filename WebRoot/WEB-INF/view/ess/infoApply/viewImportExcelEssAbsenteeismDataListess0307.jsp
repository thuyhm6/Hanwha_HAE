...
<div class="pageHeader">
	<form id="viewEssAbsenteeismDataExcelImportResultess0307" name="viewEssAbsenteeismDataExcelImportResultess0307"
			action="/ess/infoApply/viewImportExcelEssAbsenteeismDataListess0307" 
...
<div class="pageContent">
	<div class="formBar">
		<ul>			
			<li><a class="buttonActive" onclick="excelimport_viewapplyAbsenteeismbatchess0307();">
			<span><spring:message code="ar.addempshift.title.excelimport"/><!-- EXCEL导入 --></span>
				</a></li>
			<li><a class="buttonActive"
			href="/ess/infoApply/exportBatchAbsenteeismData"><span>
			...
			href="/ess/infoApply/submitImportExcelEssAbsenteeismEmpData"  title="确定要提交吗?"><span>
	...
	<table class="table" width="100%" layoutH="220" nowrapTD="false">
		...
		<tbody>
			<c:forEach items="${paEssAbsenteeismTempList}" var="item" varStatus="i">			
				<tr>
	...
	<c:set value="/ess/infoApply/viewImportExcelEssAbsenteeismDataListess0307" var="pageUrl"/>
