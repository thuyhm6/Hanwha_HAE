...
<div class="pageContent">
	<form id="addLeaveAffirmInfo" method="post" action="/ess/infoApply/addCwaAffirmInfo" class="pageForm required-validate" 
					...
					<tbody>
								<c:forEach items="${affirmorList}" var="affirmor" varStatus="j">			
									<tr id="${affirmor.AFFIRMOR_ID }">
										...
										<td class="td_type" width="100" style="text-align: center">
										<c:if test="${affirmor.AFFIRM_FLAG eq '0' && affirmor.AFFIRMOR_ID eq PERSON_ID}">
											<a rel="leaveApplyRemark" href="/ess/affirmLeaveApply/viewCwaApplyRemarkInfo?seach_APPLY_NO=${APPLY_NO }&seach_ESS_AFFIRM_NO=${affirmor.ESS_AFFIRM_NO}" 
