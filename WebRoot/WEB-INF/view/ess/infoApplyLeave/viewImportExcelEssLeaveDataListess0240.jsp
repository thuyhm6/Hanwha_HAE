...
<div class="pageHeader">
	<form id="viewEssLeaveDataExcelImportResultess024" name="viewEssLeaveDataExcelImportResultess024"
			action="/ess/infoApplyLeave/viewImportExcelEssLeaveDataListess024" 
...
<div class="pageContent">
	<div class="formBar">
		<ul>			
			<li><a class="buttonActive" onclick="excelimport_viewapplyleavebatchess0240();">
			...
			href="/ess/infoApplyLeave/submitImportExcelEssLeaveEmpData?LEAVE_TYPE=ess0240"  title="确定要提交吗?"><span>
	...
	<c:set value="/ess/infoApplyLeave/viewImportExcelEssLeaveDataListess0240" var="pageUrl"/>
