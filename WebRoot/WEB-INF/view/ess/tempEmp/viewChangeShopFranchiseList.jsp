...
$(document).ready(function(){
	...
	$("[sysLog='modifyFlag']",navTab.getCurrentPanel()).each(function(i, obj){
		...
		//休息
		if(item == '<spring:message code="ess.message.rest" />'){
	...
	//查询
	$("#viewChangeShopFranchiseList_Serch",navTab.getCurrentPanel()).click(function(){
		$("#viewChangeShopFranchiseListForm",navTab.getCurrentPanel()).submit();
	});
	//上星期
	$("#viewChangeShopFranchiseList_up",navTab.getCurrentPanel()).click(function(){
	...
	//下星期
	$("#viewChangeShopFranchiseList_down",navTab.getCurrentPanel()).click(function(){
	...
	//保存
	$("#viewChangeShopFranchiseList_Save",navTab.getCurrentPanel()).click(function(){	
		//获取页面的值
		var jsonData = '[';
		$("[sysLog='modifyFlag']",navTab.getCurrentPanel()).each(function(i, obj){
			if($(obj).html() == "modify"){
				...
				jsonData += ' "SHOP_DEPT_NO": "' + $("#SHOP_DEPT_NO_" + sysWeek + "_" + index,navTab.getCurrentPanel()).html() + '" ,';
	...
	$('.orderList tbody tr td:[sysLog="select"]',navTab.getCurrentPanel()).editable({type:'select',
		onblur:function(val,settings){
			...
			if(val == '<spring:message code="ess.message.rest" />'){
				$("td[sysWeek='" + sysWeek + "'][sysIndex='" + index + "']",navTab.getCurrentPanel()).css("background-color","red");
			}else{
	...
	$("#viewChangeShopFranchiseList_fill",navTab.getCurrentPanel()).click(function(){
			...
			if(object.checked){
				...
				$("input[name='BATCH_SHIFT']",navTab.getCurrentPanel()).each(function(i, obj){
					if(obj.checked){
						...
						if(shift == '<spring:message code="ess.message.rest" />'){
...
<form id="viewChangeShopFranchiseListForm" onsubmit="return navTabSearch(this);" action="/ess/tempEmp/viewChangeShopFranchiseList" method="post">
<div class="searchBar">
<table class="searchContent">
	<tr>
		...
		<td>
			<ait:deptList name="seach_DEPTNO" limit="manager" id="viewChangeShopFranchiseList_deptList" />
			<ait:deptTreeIcon name="seach_DEPTNO" limit="manager" id="viewChangeShopFranchiseList_deptList" selected="${DEPTNO}"/>
		</td>
...
<div class="pageHeader">
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td><!--班次--><spring:message code="ess.message.work_shift" /></td>
				<td>
			...
			<div class="subBar">
				<ul class="toolBar">
	             <li>
	            	 <a class="buttonActive" id="viewChangeShopFranchiseList_fill"><span><!--全部反应--><spring:message code="ess.message.all_reaction" /></span></a>
	             </li>
				</ul>
			</div>
	</div>
...
<div class="formBar">
	<ul class="toolBar">
		<li><a class="buttonActive" id="viewChangeShopFranchiseList_Serch" href="#"><span><!--查询--><spring:message code="ess.infoApply.SELECT" /></span></a></li>
		<li><a class="buttonActive" id="viewChangeShopFranchiseList_up" href="#"><span><!--上星期--><spring:message code="ess.message.last_week" /></span></a></li>
		<li><a class="buttonActive" id="viewChangeShopFranchiseList_down" href="#"><span><!--下星期--><spring:message code="ess.message.next_week" /></span></a></li>
		...
		<li><a class="buttonActive" href="#" onclick="downloadExcel('viewChangeShopFranchiseListForm','/disc/autoExcel/exportLOtImportExcel?SQL_SEQMEAN=222','/ess/tempEmp/viewChangeShopFranchiseList')"><span><!--Excel导出--><spring:message code="ess.infoApply.EXCEL_OUT" /></span></a></li>
		<li><a class="buttonActive" id="viewChangeShopFranchiseList_Save" href="#"><span><!--保存 --><spring:message code="ess.message.save" /></span></a></li>
	</ul>
</div>
<div class="pageContent">
				<table class="orderList" width="99%">
					<thead>
						<tr>
							<th width="3%"><!--NO.--><spring:message code="ess.infoApply.NO." /></th>
							<th width="6%"><!--社号--><spring:message code="ess.infoApply.EMPID" /></th>
							<th width="6%"><!--姓名--><spring:message code="ess.infoApply.NAME" /></th>
							<th width="8%"><!--岗位--><spring:message code="ess.message.jobStations" /></th>
							<th width="3%">
					...
					<tbody>
						<c:forEach items="${viewChangeShopFranchiseList}" var="item" varStatus="i">
