...
$(document).ready(function(){
	...
	//查询
	$("#viewWuLiuShiftSHList_Serch",navTab.getCurrentPanel()).click(function(){
		$("#viewWuLiuShiftSHListForm",navTab.getCurrentPanel()).submit();
	});
	//上星期
	$("#viewWuLiuShiftSHList_up",navTab.getCurrentPanel()).click(function(){
	...
	//下星期
	$("#viewWuLiuShiftSHList_down",navTab.getCurrentPanel()).click(function(){
	...
	//保存
	$("#viewWuLiuShiftSHList_Save",navTab.getCurrentPanel()).click(function(){	
		//获取页面的值
		var jsonData = '[';
		$("[sysLog='modifyFlag']",navTab.getCurrentPanel()).each(function(i, obj){
			if($(obj).html() == "modify"){
		...
		alertMsg.confirm("确定要保存吗？",
			  	...
			  	$.ajax({
	  				type: 'POST',
					url: '/ess/tempEmp/addShopShiftSH?typeFlag=wuLiu',
	...
	$("#viewWuLiuShiftSHList_fill",navTab.getCurrentPanel()).click(function(){
		...
		$("input[name='BATCH_WULIU_SHIFT']",navTab.getCurrentPanel()).each(function(i, obj){
			if(obj.checked){
				var index = $(obj).val();
...
function excelimport_ess3443(){
	$("#importExcelDialog_ess3443").attr('href','/pa/excelImport/importExcelData?importFunName=/importShopShiftTemp&TYPE=ess3443');
	$("#importExcelDialog_ess3443").click();
}
</script>
<a id="importExcelDialog_ess3443"  href="#" target="dialog" mask="true"></a>
<a id="importExcel_ess3443" href="#" target="navTab" mask="true"><span style="display:none;"><!-- 导入结果 --><spring:message code="ess.title.DAORUJIEGUO" /></span></a>
<div class="pageHeader">
<form id="viewWuLiuShiftSHListForm" onsubmit="return navTabSearch(this);" action="/ess/tempEmp/viewWuLiuShiftSHList" method="post">
<div class="searchBar">
<table class="searchContent">
	<tr>
		...
		<td>
			<ait:deptList name="seach_DEPTNO" limit="manager" id="viewWuLiuShiftSHList_deptList" />
			<ait:deptTreeIcon name="seach_DEPTNO" limit="manager" id="viewWuLiuShiftSHList_deptList" selected="${DEPTNO}"/>
		</td>
	...
	<div class="searchBar">
		<table class="searchContent">
			...
			<div class="subBar">
				<ul class="toolBar">
	             <li>
	            	 <a class="buttonActive" id="viewWuLiuShiftSHList_fill"><span><!--全部反应--><spring:message code="ess.message.all_reaction" /></span></a>
	             </li>
				</ul>
			</div>
	</div>
...
<div class="formBar">
	<ul class="toolBar">
		<li><a class="buttonActive" id="viewWuLiuShiftSHList_Serch" href="#"><span><!--查询--><spring:message code="org.title.SELECT" /></span></a></li>
		<li><a class="buttonActive" id="viewWuLiuShiftSHList_up" href="#"><span><!--上星期--><spring:message code="ess.message.last_week" /></span></a></li>
		<li><a class="buttonActive" id="viewWuLiuShiftSHList_down" href="#"><span><!--下星期--><spring:message code="ess.message.next_week" /></span></a></li>
		<li><a class="buttonActive" href="/pa/excelExport/downloadShopShiftExcelTemplate?file=ShopShiftAction_Add&EMP_TYPE=WULIU"><span><!--模板下载--><spring:message code="ess.message.template_download" /></span></a></li>
		<li><a class="buttonActive" href="#" onclick="excelimport_ess3443();"><span><!--Excel导入--><spring:message code="ess.infoApply.EXCEL_IN" /></span></a></li>
		<li><a class="buttonActive" href="#" onclick="downloadExcel('viewWuLiuShiftSHListForm','/disc/autoExcel/exportLOtImportExcel?SQL_SEQMEAN=267','/ess/tempEmp/viewWuLiuShiftSHList')"><span><!--导出到Excel--><spring:message code="hrm.empinfo.EXPORT" /></span></a></li>
		<li><a class="buttonActive" id="viewWuLiuShiftSHList_Save" href="#"><span><!--保存--><spring:message code="ar.viewempcalender.title.save" /></span></a></li>
	</ul>
</div>
<div class="pageContent">
				<table class="orderList" width="2660px">
					<thead>
						<tr>
							...
							<th width="30px" rowspan="2">
						    	<input type="checkbox" class="checkboxCtrl" group="BATCH_WULIU_SHIFT" />
						    </th>
					...
					<tbody>
						<c:forEach items="${viewWuLiuShiftSHList}" var="item" varStatus="i">
							<tr target="SEQ" rel="${item.SEQ}">
							    ...
							    <td style="text-align: center">
							        <input type="checkbox" id="BATCH_WULIU_SHIFT_${i.index}" name="BATCH_WULIU_SHIFT" value="${i.index}" />
							    </td>
