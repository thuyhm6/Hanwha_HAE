...
$(document).ready(function(){
	...
	//查询
	$("#viewHouQinShiftSHList_Serch",navTab.getCurrentPanel()).click(function(){
		$("#viewHouQinShiftSHListForm",navTab.getCurrentPanel()).submit();
	});
	//上星期
	$("#viewHouQinShiftSHList_up",navTab.getCurrentPanel()).click(function(){
	...
	//下星期
	$("#viewHouQinShiftSHList_down",navTab.getCurrentPanel()).click(function(){
	...
	//保存
	$("#viewHouQinShiftSHList_Save",navTab.getCurrentPanel()).click(function(){	
		//获取页面的值
		var jsonData = '[';
		$("[sysLog='modifyFlag']",navTab.getCurrentPanel()).each(function(i, obj){
			if($(obj).html() == "modify"){
	...
	$("#viewHouQinShiftSHList_fill",navTab.getCurrentPanel()).click(function(){
...
<a id="importExcel_ess3442" href="#" target="navTab" mask="true"><span style="display:none;"><!-- 导入结果 --><spring:message code="ess.title.DAORUJIEGUO" /></span></a>
<div class="pageHeader">
<form id="viewHouQinShiftSHListForm" onsubmit="return navTabSearch(this);" action="/ess/tempEmp/viewHouQinShiftSHList" method="post">
<div class="searchBar">
<table class="searchContent">
	<tr>
		...
		<td>
			<ait:deptList name="seach_DEPTNO" limit="manager" id="viewHouQinShiftSHList_deptList" />
			<ait:deptTreeIcon name="seach_DEPTNO" limit="manager" id="viewHouQinShiftSHList_deptList" selected="${DEPTNO}"/>
		</td>
	...
	<div class="searchBar">
		<table class="searchContent">
			...
			<div class="subBar">
				<ul class="toolBar">
	             <li>
	            	 <a class="buttonActive" id="viewHouQinShiftSHList_fill"><span><!--全部反应--><spring:message code="ess.message.all_reaction" /></span></a>
	             </li>
				</ul>
			</div>
	</div>
...
<div class="formBar">
	<ul class="toolBar">
		<li><a class="buttonActive" id="viewHouQinShiftSHList_Serch" href="#"><span><!--查询--><spring:message code="org.title.SELECT" /></span></a></li>
		<li><a class="buttonActive" id="viewHouQinShiftSHList_up" href="#"><span><!--上星期--><spring:message code="ess.message.last_week" /></span></a></li>
		<li><a class="buttonActive" id="viewHouQinShiftSHList_down" href="#"><span><!--下星期--><spring:message code="ess.message.next_week" /></span></a></li>
		<li><a class="buttonActive" href="/pa/excelExport/downloadShopShiftExcelTemplate?file=ShopShiftAction_Add&EMP_TYPE=HOUQIN"><span><!--模板下载--><spring:message code="ess.message.template_download" /></span></a></li>
		...
		<li><a class="buttonActive" href="#" onclick="downloadExcel('viewHouQinShiftSHListForm','/disc/autoExcel/exportLOtImportExcel?SQL_SEQMEAN=266','/ess/tempEmp/viewHouQinShiftSHList')"><span><!--导出到Excel--><spring:message code="hrm.empinfo.EXPORT" /></span></a></li>
		<li><a class="buttonActive" id="viewHouQinShiftSHList_Save" href="#"><span><!--保存--><spring:message code="ar.viewempcalender.title.save" /></span></a></li>
	</ul>
</div>
<div class="pageContent">
				<table class="orderList" width="2660px">
					...
					<tbody>
						<c:forEach items="${viewHouQinShiftSHList}" var="item" varStatus="i">
