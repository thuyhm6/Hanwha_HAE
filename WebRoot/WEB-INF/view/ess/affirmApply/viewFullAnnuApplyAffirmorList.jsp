...
<div class="pageContent">
	...
	<c:set value="/ess/affirmApply/viewFullAnnuApplyAffirmorList?seach_APPLY_TYPE_NO=216691&seach_APPLY_NO=${annulist.APPLY_NO}" var="pageUrl"/>
	<%@ include file="/WEB-INF/view/inc/initPagination.jsp"%>
</div>
</c:if>
<div class="pageContent">
	<form id="addLeaveAffirmInfo" method="post" action="/ess/affirmApply/addAuunAffirmInfo" class="pageForm required-validate" 
		...
		<div>
			<table class="user_table" width="100%">	
				...
				<tr>
					...
					<td class="td_type" style="text-align: center" colspan="3">${annumap.ANNUAL_LEAVE_REASON }</td>
				</tr>
				</c:if>
				<tr>
									...
									<tr id="${affirmor.AFFIRMOR_ID }">
										...
										<td class="td_type">
											...
											<c:if test="${affirmor.AFFIRMOR_ID eq PERSON_ID}">
												<input type="text" id="AFFIRM_CONTENT" name="AFFIRM_CONTENT" title="批注" size="20" 
										...
										<c:if test="${affirmor.AFFIRM_FLAG eq '0' && affirmor.AFFIRMOR_ID eq PERSON_ID }">
										 	<a rel="leaveApplyRemark" href="/ess/affirmLeaveApply/viewAnnuApplyRemarkInfo?seach_APPLY_NO=${APPLY_NO }&seach_ESS_AFFIRM_NO=${affirmor.ESS_AFFIRM_NO}" 
												title="添加Checkor" target="dialog"   mask="true" width="600" height="350" id="leaveApplyRemarkHref">
