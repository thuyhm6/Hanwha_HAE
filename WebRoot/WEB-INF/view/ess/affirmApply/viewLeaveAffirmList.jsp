...
function validateAffirmLeaveApplyCallbackEss0802(form,callback,flag) {
    ...
    $form.attr("action","/ess/affirmApply/approveLeaveApplyInBatch?AFFIRM_FLAG="+flag+"&AFFIRM_TYPE=LEAVE_AFFIRM");
...
function pageFromSea(a){                         
	...
	var seach_APPLY_TYPE_CODE="2449";
	$("#pagerForm",navTab.getCurrentPanel()).attr("action", "/ess/affirmApply/viewLeaveAffirmList?seach_KEY="+seach_KEY+"&seach_DEPT_NO="+seach_DEPT_NO+"&seach_START_DATE="+seach_START_DATE+"&seach_END_DATE="+seach_END_DATE+"&seach_STATUS_CODE="+seach_STATUS_CODE+"&seach_APPLY_TYPE_CODE="+seach_APPLY_TYPE_CODE+"&seach_APPLY_TYPE_CODE="+seach_APPLY_TYPE_CODE);
}
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="/ess/affirmApply/viewLeaveAffirmList" method="post" 
			                            ...
			                            <c:choose>
									        <c:when test="${affirmer.AFFIRMOR_ID == leaveApplyAffirm.CURRENT_AFFIRM_ID && affirmer.AFFIRM_LEVEL == leaveApplyAffirm.AFFIRM_LEVEL }">									
										         <c:if test="${affirmer.HREF_FLAG == 1}" >
												    <a href="/ess/affirmApply/approveLeaveApply?ESS_AFFIRM_NO=${affirmer.ESS_AFFIRM_NO}&AFFIRM_FLAG=1&AFFIRM_TYPE=LEAVE_AFFIRM" target="ajaxTodo">
							                           <span style="color:blue;">&nbsp;<spring:message code="ess.viewApply.title.pass"/><!--通过--></span>
													</a>
												    <a href="/ess/affirmApply/approveLeaveApply?ESS_AFFIRM_NO=${affirmer.ESS_AFFIRM_NO}&AFFIRM_FLAG=2&AFFIRM_TYPE=LEAVE_AFFIRM" target="ajaxTodo">
