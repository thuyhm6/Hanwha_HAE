				...
				<tr>
					<td colspan="6">
						<table class="user_table" width="100%" border="0">
							<tr>
								<td class="td_title" style="text-align: center;width:10%;">社号|姓名</td>
								<td class="td_type" style="text-align: left;width:15%;">[${infoApplyOt.EMPID}]${infoApplyOt.LOCAL_NAME}</td>
								<td class="td_title" style="text-align: center;width:10%;">部门</td>
								<td class="td_type" style="text-align: left;width:15%;">${infoApplyOt.DEPT_NAME} </td>
								<td class="td_title" style="text-align: center;width:10%;">加班日期</td>
								<td class="td_type" style="text-align: left;width:15%;">${infoApplyOt.APPLY_OT_DATE}</td>
								<td class="td_title" style="text-align: center;width:10%;">加班长度</td>
								<td class="td_type" style="text-align: left;width:15%;">${infoApplyOt.OT_APPLY_HOUR}&nbsp;&nbsp;&nbsp;&nbsp;</td>
							</tr> 
							<tr>
								<td class="td_title" style="text-align: center;width:10%;">考勤类型</td>
								<td class="td_type" style="text-align: left;width:15%;">${infoApplyOt.OT_TYPE_NAME}</td>
								<td class="td_title" style="text-align: center">附件</td>
								<td class="td_type" style="text-align: left;width:15%;">
								...
								<td class="td_title" style="text-align: center;width:10%;">申请事由</td>
								<td clospan='5'>${infoApplyOt.APPLY_OT_REMARK}</td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td colspan="6">
						<table class="user_table" width="100%" border="0">
							<tr>
								<td class="td_title" style="text-align: center;width:10%;">社号|姓名</td>
								<td class="td_type" style="text-align: left;width:20%;">[${infoApplyOt.EMPID}]${infoApplyOt.LOCAL_NAME}</td>
								<td class="td_title" style="text-align: center;width:10%;">部门</td>
								<td class="td_type" style="text-align: left;width:20%;">${infoApplyOt.DEPT_NAME} </td>
								<td class="td_title" style="text-align: center;width:10%;">加班开始时间</td>
								<td class="td_type" style="text-align: left;width:30%;">${infoApplyOt.OT_FROM_TIME}</td>
							</tr>
							<tr>
								<td class="td_title" style="text-align: center;width:10%;">加班结束时间</td>
								<td class="td_type" style="text-align: left;width:20%;">${infoApplyOt.OT_TO_TIME}</td>
								<td class="td_title" style="text-align: center;width:10%;">考勤类型</td>
								<td class="td_type" style="text-align: left;width:20%;">${infoApplyOt.OT_TYPE_NAME}</td>
								<td class="td_title" style="text-align: center;width:10%;">申请事由</td>
								<td class="td_type" style="text-align: left;width:30%;">${infoApplyOt.APPLY_OT_REMARK}</td>
							</tr>
						</table>
					</td>
				</tr>
