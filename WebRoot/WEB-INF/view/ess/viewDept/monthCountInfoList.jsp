...
function searthURL() {
	...
	var years = "";
	if(year!=''&&year!=null){
		var years=parseInt(year)+1;  //例如   2015年份加一  为的是区组织中2015的最后一次组织变更  
		}
	...
	var dept = $("input[syslong='monthCountInfoList_seachDept1']").val();
		...
		<form class="j-ajax" action="/ess/viewDept/ManageCountInfoSonList"
			...
			<table class="searchContent">
				...
				<tr>
					...
					<td>
                   	<input id="seach_YEAR" type="text" name="seach_YEAR"  class="Wdate" onClick="WdatePicker({dateFmt:'yyyy',lang:'en'})" value="${DDATE}"/>			
					</td>
					<td>
						<!-- 部门： -->
					...
					<td>
						<ait:deptList name="seach_DEPT_NO1" cpnyId="${defaultCpny}" limit="manager"
							id="monthCountInfoList_seachDept1" />
						<ait:deptTreeIcon name="seach_DEPT_NO1" cpnyId="${defaultCpny}" limit="manager"
							id="monthCountInfoList_seachDept1" selected="${DEPTNO}" />
					</td>
				</tr>
				<tr>
					<td>
		...
		<div class="tabsHeader">
			<div class="tabsHeaderContent">
				<ul>
					...
					<li>
						<a id="hreff11"
							href="/ess/viewDept/monthCountInfoSonList?DEPTNO=${DEPTNO }&RESUME_NO=${RESUME_NO }&SON_FLAG=${SON_FLAG }&currentIndex=1"
							type="/ess/viewDept/monthCountInfoSonList?DEPTNO=${DEPTNO }&RESUME_NO=${RESUME_NO }&SON_FLAG=${SON_FLAG }&currentIndex=1"
							class="j-ajax"><span id="link11"><!--月别采用现况 --><spring:message code="ess.infoApply.month_level_adopt_status" /></span> </a>
					</li>
