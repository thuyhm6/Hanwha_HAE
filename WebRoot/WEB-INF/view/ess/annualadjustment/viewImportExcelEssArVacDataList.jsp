...
<div class="pageHeader">
	<form id="viewEssArVacDataExcelImportResult" name="viewEssArVacDataExcelImportResult"
			action="/ess/annualadjustment/viewImportExcelEssArVacDataList" 
...
<div class="pageContent">
	<div class="formBar">
		<ul>			
			<li><a class="buttonActive" onclick="excelimport_viewapplyArVacbatch();">
			<span><spring:message code="ar.addempshift.title.excelimport"/><!-- EXCEL导入 --></span>
				</a></li>
			<li><a class="buttonActive"
			href="/ess/annualadjustment/exportBatchLeaveData"><span>
			...
			href="/ess/annualadjustment/submitImportExcelEssArVacEmpData"  title="确定要提交吗?"><span>
	...
	<c:set value="/ess/annualadjustment/viewImportExcelEssArVacDataList" var="pageUrl"/>
