...
<div class="pageContent" >
	<form id="checkApplyInfo" method="post" action="/ess/affirmLeaveApply/AnnucheckApplyInfo" class="pageForm required-validate" 
   ...
   <table class="user_table" width="100%"  border="0">
	<tr>
		...
		<table class="user_table" width="100%" layoutH="60" border="1">
			...
			<tr>
				...
				<td class="td_title" width="5%" style="text-align: center"><!-- 决裁等级 -->
					决裁等级
				</td>
				<td class="td_title" width="25%" style="text-align: center"><!-- 决裁者 -->
					决裁者
				</td>
			...
			<c:forEach items="${affirmorList}" var="affirmor" varStatus="i">			
				<tr>
					<td class="td_type" width="5%" style="text-align: center">${affirmor.AFFIRM_LEVEL}</td>
					<td class="td_type" width="25%" style="text-align: center">[${affirmor.EMPID}]${affirmor.LOCAL_NAME}</td>
