...
<div class="pageContent">
	<form id="viewLeaveApplyRemarkInfo" method="post" action="/ess/affirmLeaveApply/addAnnuApplyCheckList" class="pageForm required-validate" 
						...
						<table class="searchContent">
							<tr>
								...
								<td>
									...
									<input id="PAGE_FLAG" name="PAGE_FLAG" value="${APPLY_NO }" type="hidden"/>
