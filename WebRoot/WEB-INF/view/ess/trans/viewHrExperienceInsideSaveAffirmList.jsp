...
function validateApproveProbationCallback(form,callback,flag) {
    ...
    $form.attr("action","/ess/trans/viewHrExperienceInsideSaveAffirmList1");
...
function titleName(value1) {
	...
	$.ajax( {
				...
				success : function(data) {
					...
					htm += '<tr>';
					htm+='<td class="td_title"><input type="checkbox"/>全选</td>';
					...
					//htm += '</td>';
					htm+='<td class="td_title">裁决人</td><td class="td_title">裁决状态</td>';
					htm += '</tr>';
					htm += '</table>';
...
<%--				cache : false,--%>
<%--				type : 'post',--%>
<%--				url : "/ess/trans/viewHrExperienceInsideSaveAffirmList1?",--%>
<%--				data : 'code=' + value1+'&codeText='+codeText+"&OrderType="+value1,--%>
<%--				dataType : "json",--%>
<%--				success : function(data) {	--%>
<%--					$.each(data, function(key, value) {--%>
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="/ess/trans/viewHrExperienceInsideSaveAffirmList1" method="post" 
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				...
				<spring:message code="heran.ess.viewHrExperienceInsideSave.DIAOLINGLEIXING"/><!--调令类型-->:
...
<table class="table" width="100%" layoutH="150" nowrapTD="false">
	...
	<c:forEach items="${title}" var="temp">      
