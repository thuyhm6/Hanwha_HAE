...
<h1><!-- 表彰事项 --><spring:message code="ess.empInfo.commend_matter" /></h1>
		...
		<div class="pageFormContent" layoutH="56">
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td class="td_title" >
						<!-- 表扬（得奖）日 --><spring:message code="ess.empInfo.Praise_day_award_date" />
					</td>
				...
				<tr>
			     ...
			     <!-- 奖金 --><spring:message code="ess.empInfo.bonus" />
					...
					<td class="td_title" >
			     <!-- 奖金支付类型代码 --><spring:message code="hrm.empinfo.Bonus_payment_code" />
					</td>
