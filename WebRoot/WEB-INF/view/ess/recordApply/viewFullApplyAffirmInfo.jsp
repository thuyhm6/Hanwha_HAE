...
<div class="pageContent">
	...
	<c:set value="/ess/recordApply/viewFullApplyAffirmInfo?seach_APPLY_TYPE_NO=218294&seach_APPLY_NO=${arMacRecord.RECORD_NO}" var="pageUrl"/>
...
<div class="pageContent" >
	...
	<table class="user_table" width="100%" border="0">
	  <tr>
	    <td class="td_title" width="6%" style="text-align: center"  > 
					申请人
		</td>
		<td class="td_type" width="14%" style="text-align: center"  > 
					 [${arMacRecord.EMPID}]-${arMacRecord.LOCAL_NAME}
		</td>
		<td class="td_title" width="6%" style="text-align: center"  > 
					 部门
		</td>
		<td class="td_type" width="14%" style="text-align: center"  > 
					 ${arMacRecord.DEPT_NAME}
		</td>
		<td class="td_title" width="6%" style="text-align: center"  > 
					漏刷卡日期
		</td>
	  ...
	  <td class="td_title" style="text-align: center">附件</td>
		...
		<c:if test="${arMacRecord.CPNY_ID ne 'LGEPN'}">
		  	<td class="td_title" style="text-align: center">本月申请次数</td>
			<td>${arMacRecord.MAC_APPLY_CNT }</td>	
	     	<td class="td_title" style="text-align: center"  > 
						 申请事由
			</td>
			<td class="td_type"  style="text-align: left;"  colspan="5"> 
						 ${arMacRecord.REMARK }
			</td>
		</c:if>
	  </tr>
