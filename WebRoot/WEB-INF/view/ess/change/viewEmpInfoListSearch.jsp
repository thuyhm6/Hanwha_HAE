...
<form id="viewEmpInfo" onsubmit="return dwzSearch(this,'dialog');" action="/ess/change/viewEmpInfoListSearch?firstFlag=N&searchChange=${searchChange }&defaultCpny=${defaultCpny }" method="post" rel="pagerForm">
...
<div class="pageContent">
			...
			<tr id='xp' ondblclick="changeUrlToNavTabNum('/ess/change/changeUser?PERSON_ID_ID=${keeper.PERSON_ID}','pageNum=1&menuNo=14014333&navTabId=sy0501','sy0501','员工信息改变管理');javascript:
							$.bringBack({
				...
				<td>${keeper.EMPID}--${keeper.PERSON_ID}</td>
			...
			<form id="pagerForm" method="post" action="/ess/change/viewEmpInfoListSearch?firstFlag=N&searchChange=${searchChange }&defaultCpny=${defaultCpny }">
