		...
		$.ajax({
			 ...
			 success: function(data) {
				...
				if (applyTypeCode=='141474') {
					...
					var length = data.result[0].LEAVE_LENGTH % data.result[0].DAY_HOUR ;
					if(length > 0 ){
...
<div class="pageContent" style="padding-top:5px;">
		<form id="viewSSTApplyAttendance_form" method="post" action="/ess/infoApplyLeave/addLeaveBussinessSST">
							...
							<table  class="user_table" width="100%">
								<tr>
								   <td style="text-align:right" width="20%" class="td_title">
										<!--考勤类型 --> <spring:message code="hrm.empinfo.Registration_type" />
									</td>
									<td width="30%" class="td_type">
									 	...
									 	<input type="hidden" id="APPLY_TYPE_CODE" name="APPLY_TYPE_CODE" value="124851"/>
									 	Đi công tác
									</td>
								...
								<tr>
									...
									<td width="80%" class="td_type" colspan=3>
										...
										<input type="hidden" name="fromTime" id="fromTime" value="08:00"/>
								...
								<tr>
									...
									<td width="80%" class="td_type" colspan=3>
										...
										<input type="hidden" name="toTime" id="toTime" value="17:00"/>
