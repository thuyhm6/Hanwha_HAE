...
$(document).ready(function(){
      $("#viewApplyOTBatchInfoHAEList_Serch",navTab.getCurrentPanel()).click(function(){
			$("#viewApplyOTBatchInfoHAEList",navTab.getCurrentPanel()).submit();
	   });
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="/ess/infoApplyAttendance/viewApplyOTBatchInfoHAEList?firstFlag=N" method="post"
		id="viewApplyOTBatchInfoHAEList" name="viewApplyOTBatchInfoHAEList">
		<div class="searchBar">
...
<div class="formBar">
	<ul class="toolBar">
	<li><a class="buttonActive" id="viewApplyOTBatchInfoHAEList_Serch" href="#"><span><!-- 查询 --><spring:message code="hrm.empinfo.QUERY"/></span></a></li>
	<li>
		<a class="buttonActive" onclick="downloadExcel('viewApplyOTBatchInfoHAEList','/disc/autoExcel/exportLOtImportExcel?SQL_SEQMEAN=298&CPNY=${LoginUser.cpnyId}','/ess/infoApplyAttendance/viewApplyOTBatchInfoHAEList?firstFlag=N')"><span>
