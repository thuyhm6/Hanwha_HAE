...
<div class="pageContent">
	<form id="affirmEditionItemInfo" method="post" action="/ess/dimissionApply/updatePersonEditionParamInfo" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone)">
		...
		<div class="pageFormContent">
			   ...
			   <c:forEach items="${affirmItemList}" var="item" varStatus="i">
				<tr>
					...
					<td colspan="2" style="text-align:left">${item.EDITION_ITEM_NAME }</td>
