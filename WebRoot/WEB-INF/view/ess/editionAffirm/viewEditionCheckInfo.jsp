...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/ess/editionAffirm/viewEditionAffirmList" 
		method="post">
	<div class="formBar">
			<ul>
				<li>
...
<div class="pageContent">
	<table width="100%"  border="0" layoutH="200" cellpadding="0" cellspacing="0" class="table" >
		<thead>
			<tr>
				<th width="5%">
					<!-- 工号 -->
		...
		<table width="100%"  border="0" layoutH="200" cellpadding="0" cellspacing="0" class="user_table margin_b" >
			...
			<c:forEach items="${affirmorList}" var="affirmor" varStatus="i">			
				<tr>
					...
					<td class="td_type" width="15%" style="text-align: center">${affirmor.DEPT_NAME}</td>
			...
			<tr>
				<td class="td_title" colspan="7"><br/></td>
			</tr>
			<tr>
			...
			<c:if test="${checkorListCnt == 0}">
				...
				<td class="td_type" width="15%" style="text-align: center" rowspan="2">Public</td>
					...
					<td class="td_type" width="45%" style="text-align: center" colspan="3">无</td>
				</tr>
			</c:if>
		</table>
	</form>
