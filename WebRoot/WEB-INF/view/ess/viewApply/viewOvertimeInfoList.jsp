...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="/ess/viewApply/viewOvertimeInfoList" rel="pagerForm" method="post">
	<div class="searchBar">
	...
	<table class="table" width="100%" layoutH="196" nowrapTD="false">
		<thead>
			<tr>
				...
				<th width="180" style="text-align: center"><!--部门-->
					<spring:message code="public.title.deptName"/>
				</th>
				<th width="100" style="text-align: center"><!--职岗位-->
