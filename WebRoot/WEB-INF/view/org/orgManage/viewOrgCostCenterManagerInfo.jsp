...
<div class="pageContent">
	<div class="user_table" style="font:bold 12px/20px arial,sans-serif;">Total:${deptManagerCheckCnt}</div>
				<table class="table" width="100%" layout="200">
					<thead>
						<tr>
							<th width="30px">No.</th>
							<th width="150px"><spring:message code="org.title.dept" /><!-- 部门 --></th>
							<th width="80px"><spring:message code="org.title.COST_CENTER_NO" /><!-- 成本中心代码 --></th>
							<th width="80px"><spring:message code="org.title.COST_CENTER" /><!-- 成本中心 --></th>
