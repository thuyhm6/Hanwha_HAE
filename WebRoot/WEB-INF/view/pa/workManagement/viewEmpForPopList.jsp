...
function changeUrlToNavTabNum(url, menu_code, menu_name, empid, empInfoShow,
	...
	if (window.parent.document.getElementById('seach_KEY') != undefined)
		window.parent.document.getElementById('seach_KEY').value = empid;
	if (url == '')
		return;
	url = url.replace('^','&');
		...
		<div class="searchBar">
			<table class="searchContent">
				<tr
					...
					<td>
						<ait:deptList name="seach_DEPTNO" limit="${limit}"
							id="viewEmpCalendarList_seachDept" />
						<ait:deptTreeIcon name="seach_DEPTNO" limit="${limit}"
	...
	<table class="table" layoutH="130" targetType="dialog" width="100%">
		<thead>
			<tr>
				...
				<th>
					<!-- 职级--><spring:message code="hr.viewPersonalInfo.title.POST_GRADE_NAME" />
				</th>
			...
			<c:if test="${totalCount == 0 }">
				<tr>
					<td style="text-align: left" colspan="7">
						<!-- 没有任何数据 --><spring:message code="ar.viewEmpForPopList.MEIYOURENHESHUJU.b" />
					</td>
				</tr>
			</c:if>
		</tbody>
