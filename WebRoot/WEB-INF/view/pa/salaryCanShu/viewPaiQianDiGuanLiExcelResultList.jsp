...
<script>
	function viewPaiQianDiInfoModule(){
		$("#importExcelDialog_pa0801_temp").attr('href','/pa/excelImport/importPaiQianDiGUanLiInfoData?importFunName=/viewPaiQianDiInfoModule');
		$("#importExcelDialog_pa0801_temp").click();
	}
</script>

<a id="importExcelDialog_pa0801_temp"  href="#" target="dialog" mask="true"></a>
<a id="importExcel_pa0801_temp"  href="#" target="navTab" mask="true">
	<span style="display:none;"><spring:message code="pa.salary.canShu.pQdDaoRuJieGuo"/>派遣地导入结果</span>
</a>

<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="/pa/salaryCanShu/viewPaiQianDiGuanLiExcelResultList" method="post" rel="pagerForm" 
		id="viewPaiQianDiGuanLiExcelResultList" name="viewPaiQianDiGuanLiExcelResultList">
	<div class="searchBar" >
...
<div class="pageContent">
	...
	<div style="float:right;">
		<a class="buttonActive" id ="exportExcel" title="导出导入的数据" href="/pa/salaryCanShu/viewImportPqdDataExcel">
			<%--href="/pa/excelExport/exportPaiQianDiGuanLiTempInfoList?RESULT_FLAG=${RESULT_FLAG}"> --%>
			<SPAN><!-- EXCEL导出 -->
	...
	<div style="float:right; ">
		<a class="buttonActive" target="ajaxTodo" callback="navTabAjaxDoneRefreshCurrentPage"
			<%-- href="/pa/tempsale/submitImportExcelTempPqdGuanLiData"  title="确定要提交吗?">--%>
			href="/pa/salaryCanShu/savePaiQianDiDataImport"  title="确定要提交吗?">
			<span><!--提交-->
	...
	<table class="table" width="100%" layoutH="198">
		<thead>
			<tr>
				...
				<th width="50"><spring:message code="pa.salary.canShu.shengFen"/><!--省份--></th>
				...
				<th width="80"><spring:message code="pa.salary.canShu.yanZhengJieGuo"/><!--验证结果--></th>
			</tr>
		</thead>
		<tbody>
			<c:forEach items="${paiQianDiList}" var="pQd" varStatus="i">
				<tr target="PQD_NO" rel="${pQd.NO1}">
					...
					<td><center>${pQd.RESULT}</center></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
	<c:set value="/pa/salaryCanShu/viewPaiQianDiGuanLiExcelResultList" var="pageUrl"/>
