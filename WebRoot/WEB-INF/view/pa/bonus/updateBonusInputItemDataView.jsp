...
<div class="pageContent">
	<form method="post" action="/pa/bonus/updateBonusInputItemDataInfo" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<p>
				<label><spring:message code="pa.insurance.title.parmeterSeq"/><!--参数序号--></label>
			...
			<p>
				...
				<input type="text" name="FIELD1_VALUE_KR" value="${paInputItemDataInfo.FIELD1_VALUE_KR }" class="textInput required">
			</p>
			<p>
				<label><spring:message code="pa.insurance.title.filed2KoreaName"/><!--字段2韩文--></label>
				<input type="text" name="FIELD2_VALUE_KR" value="${paInputItemDataInfo.FIELD2_VALUE_KR }" class="textInput required">
			</p>
