...
<div class="pageContent">
	<form method="post" action="/pa/bonus/updateBonusComputeItemInfo"
		...
		<div class="pageFormContent" layoutH="56">
			<dl>
				...
				<dd>
					<input id="ITEM_ID" NAME="ITEM_ID" type="text" value="${bonusComputeItemInfo.ITEM_ID}" class="required alphanumeric" maxlength="30" />	
					<input name="NO" type="hidden" size="30"
						value="${bonusComputeItemInfo.ITEM_NO }" />
				</dd>
			</dl>
			<ait:SyLanguage languageNo="${bonusComputeItemInfo.ITEM_NO }" />
			<dl>
				<dt>
			...
			<dl>
				...
				<dd>
					<textarea cols="100" rows="4" class="l-textarea" name="DESCR"
						id="DESCR" style="width: 400px" maxlength="4000">${bonusComputeItemInfo.DESCR }</textarea>
				</dd>
			</dl>
		</div>
		<div class="formBar">
