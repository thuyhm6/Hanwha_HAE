...
<div class="pageContent">
	...
	<form method="post" id="bonusFormularForm" action="/pa/bonus/addBonusFormulaInfo" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
