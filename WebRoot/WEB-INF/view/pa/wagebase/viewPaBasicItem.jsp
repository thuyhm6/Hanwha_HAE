...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/pa/wagebase/viewPaBasicItem" method="post" rel="pagerForm">
		<div class="searchBar">
...
<div class="pageContent">
	<c:set value="/pa/wagebase/addPaBasicItemView" var="add_Url" />
	<c:set value="600" var="add_width" />
	<c:set value="500" var="add_height" />
	<c:set value="/pa/wagebase/deletePaBasicItemInfo?NO={ITEM_NO}"
		var="delete_Url" />
	<c:set value="/pa/wagebase/updatePaBasicItemView?NO={ITEM_NO}"
		var="edit_Url" />
	...
	<table class="table" width="100%" layoutH="140">
		...
		<tbody>
			<c:forEach items="${paBasicItemList}" var="item" varStatus="i">
				...
				<tr target="ITEM_NO" rel="${item.ITEM_NO}">
					<td>
						${item.ITEM_ID}
					</td>
					<td>
	...
	<c:set value="/pa/wagebase/viewPaBasicItem" var="pageUrl" />
