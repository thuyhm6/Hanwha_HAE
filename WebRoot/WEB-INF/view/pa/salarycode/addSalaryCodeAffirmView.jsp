		    ...
		    <dl>
				...
				<dd>
					<select id="PROJECT_TYPE" name="PROJECT_TYPE">
						<option value="1">
							<spring:message code="pa.wagebase.title.basicItemInfo"/><!--数字类型-->
						</option>
						<option value="2">
							<spring:message code="pa.salary.title.inputItem"/><!--字符类型-->
						</option>
						<option value="3">
							<spring:message code="pa.salary.title.caculateItem"/><!--字符类型-->
						</option>
					</select>
				</dd>
			</dl>
