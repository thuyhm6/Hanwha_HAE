...
//  * 开始加载部门树
//  */
// var setting_pa1109_add_viewAffirmor = { 
// 		view: {
...
// 			    var deptName = $("#deptName_pa1109_add_0_viewAffirmors").val();
// 				if(deptName == treeNode.CONTENT){
// 					 $("#deptName_pa1109_add_0_viewAffirmors").attr("value", '');
// 					 $("#seach_DEPTNO_viewAffirmors").attr("value",'');
// 			    }else{
// 					 $("#deptName_pa1109_add_0_viewAffirmors").attr("value", treeNode.DEPTNAME);
...
// function showTree_pa1109_add_viewAffirmors(obj) {
// 		var cityObj = $("#"+obj.id);
// 		var cityOffset = $("#"+obj.id).offset();
// 		$("#deptContent_pa1109_add_viewAffirmors").offset({
// 			top:cityOffset.top + "px", 
// 			left:cityOffset.left + cityObj.outerHeight() + "px" 
// 		}).slideDown("fast");
// 		$("body").bind("mousedown", onBodyDown_pa1109_add_viewAffirmors);
// }
// function hideMenu_pa1109_add_viewAffirmors() {
// 	 	 $("#deptContent_pa1109_add_viewAffirmors").fadeOut("fast");
// 	 	 $("body").unbind("mousedown", onBodyDown_pa1109_add_viewAffirmors);
// }
// function onBodyDown_pa1109_add_viewAffirmors(event) {
// 	 var str=event.target.id;
// 	 if(str.indexOf("switch")==-1&&str.indexOf("_span")>-1){
// 		 if(str!="deptContent_pa1109_add_viewAffirmors"){
// 			 hideMenu_pa1109_add_viewAffirmors();
// 		 }
// 	 }
// }
加载部门树结束
//  $(document).ready(function(){
// 		$.fn.zTree.init($("#deptTree_pa1109_add_viewAffirmors"), setting_pa1109_add_viewAffirmor, zNodes_pa1109_add);
// });
//加载部门树结束
</script>
<div class="pageHeader">

	<form method="post" action="/sys/affirm/viewPersonList?navTabId=${param.navTabId}" rel="pagerForm">
			...
			<tr>
				...
				<td>
					<!--  部门：<ait:deptTree name="seach_DEPTNO" limit="hr" selected="${DEPTNO}" />-->
					  <input id="deptName_pa1109_add_0_viewAffirmors" name ="seach_DEPTNAME" type="text" readonly  value="${DEPTNAME}"/> 
				  	  <input id="seach_DEPTNO_viewAffirmors" name="seach_DEPTNO" type="hidden" sysLong="pa1109"  value="${DEPTNO}"/>	
				  	  	<div id="deptContent_pa1109_add_viewAffirmors"  style="display:none; position: absolute;z-index:100;overflow:auto;height:350px; border:solid 1px #CCC; line-height:21px; background:#FFF;" >
							<ul id="deptTree_pa1109_add_viewAffirmors" class="ztree" style="margin-top:0; width:300px;">
							</ul>
						</div>
				</td>
			</tr>
...
<div class="pageContent">
	...
	<form id="pagerForm" method="post" action="/sys/affirm/viewPersonList?navTabId=${param.navTabId}">
	<div class="panelBar">
		<div class="pages">
