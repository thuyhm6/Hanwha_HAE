...
<body> 
	<center>
		...
		<form id="addimgform" method="post" action="/pa/excelImport/${importFunName}?id=${id}&type=${type}&FIELD1=${FIELD1_NAME}&FIELD2=${FIELD2_NAME}" 
			enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return uploadExcel(this,dialogAjaxDone);" target="callbackframe">
			   <table width="100%" >
				   <tr><td style="text-align: center;padding:5px"><font color=red><!-- 提示：目前只支持以xls后缀结尾的excel格式（2003版本） --><spring:message code="ar.alert.message.excelimport.friendasu"/></font></td></tr>
				   <tr><td style="text-align: center;padding:5px">&nbsp;&nbsp;<input type="file" name="filename" id="filename"/>
