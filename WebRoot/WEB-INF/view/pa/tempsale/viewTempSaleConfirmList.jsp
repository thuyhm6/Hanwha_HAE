...
<form onsubmit="return navTabSearch(this);"
	action="/pa/tempsale/viewTempSaleConfirmList" rel="pagerForm" method="post">
<div class="searchBar">
			...
			<tr>
				...
				<td style="text-align:center">
					...
					<c:if test="${item.AFFIRM_FLAG_PERSON ne '1'}">
						<a href="/pa/tempsale/viewTempSaleEmpInfoList?pageNum=1&navTabId=pa0701_EMPINFO&EVENT_ID=${item.EVENT_ID }" target="navTab" rel="pa0701_EMPINFO">审批查看</a>
					</c:if>
				</td>
			</tr>
		</c:forEach>
...
<c:set value="/pa/tempsale/viewTempSaleConfirmList?seach_YEAR=${YEAR}&seach_MONTH=${MONTH}&seach_ACCRUAL_YN=${ACCRUAL_YN}" var="pageUrl" /> 
