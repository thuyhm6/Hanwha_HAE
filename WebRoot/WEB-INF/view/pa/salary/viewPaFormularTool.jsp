...
<script type="text/javascript">
    function filltext(values) {
		if (parent){
			if (parent.paformularForm) {
				if($(":radio:checked").val() == 'CONDITION'){
					var target = parent.paformularForm.CONDITION;
				}else{
					var target = parent.paformularForm.FORMULAR;
				}
				target.value+=values+' ';
			}
		}
...
<table width="100%" height="300" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" 
  ...
  <tr align="center" >
    ...
    <select name="select" id="paBasicItem" size="15" style="width:150px " onClick="filltext(this.value)">
    ...
    <td  align="center"  style="padding:5 5 5 5 " valign="top">
	 	<select name="select" id="paInputItem" size="15" style="width:150px " onClick="filltext(this.value)">
	...
	<td align="center"  style="padding:5 5 5 5 " valign="top">
    <select name="select" id="paComputeItem" size="15" style="width:150px " onClick="filltext(this.value)">
	...
	<%-- <td  align="center"  style="padding:5 5 5 5 " valign="top">
	 	<select name="select" id="insuranceInputItem" size="15" style="width:150px " onClick="filltext(this.value)">
	...
	<td  align="center"  style="padding:5 5 5 5 " valign="top">
	 	<select name="select" id="arItem" size="15" style="width:200px " onClick="filltext(this.value)">
	    <c:forEach items="${arItemList}" var="paList">
				<option value="${paList.COLUMN_NAME}">
		    	 ${paList.ITEM_NAME} 
		    	</option>
		</c:forEach>
    </select>
	...
	<td  align="center"  style="padding:5 5 5 5 " valign="top">
	 	<select name="select" id="fixedParameter" size="15" style="width:150px " onClick="filltext(this.value)">
