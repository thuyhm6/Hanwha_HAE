...
<div class="pageHeader">
	<form method="post" action="/pa/salary/viewAddPaPersonalDataList?navTabId=${param.navTabId}" 
	...
	<div class="searchBar" >
		<table class="searchContent">
			...
			<tr>
			   	...
			   	<td>人员类型组 </td>
						<td>
						<input type="hidden" id="viewAddPaPersonalDataList_limit" name="limit" value="pa">
						<input type="hidden" id="viewAddPaPersonalDataList_seach_CPNY" name="seach_CPNY" value="${defaultCpny}">
			<ait:SelectEmpTypeCode  id="viewAddPaPersonalDataList_seach_JobTypeGroupNo"  name="seach_JobTypeGroupNo" selected="${JobTypeGroupNo}" limit="pa" type="group"
			onChangeName="ajaxEmpTypeForGroupToList(-1,viewAddPaPersonalDataList_seach_JobTypeGroupNo,viewAddPaPersonalDataList_seach_EmpTypeCodeNo,viewAddPaPersonalDataList_seach_CPNY,viewAddPaPersonalDataList_limit)"/>
						</td>
						<td>人员类型 </td>
						<td>
		 	<ait:SelectEmpTypeCode id="viewAddPaPersonalDataList_seach_EmpTypeCodeNo" name="seach_EmpTypeCodeNo" selected="${EmpTypeCodeNo}" limit="pa"/>
						</td>
				    <td>在职状态</td>
						<td>
...
<div class="pageContent">	
	...
	<form id="pagerForm" method="post" action="/pa/salary/viewAddPaPersonalDataList?navTabId=${param.navTabId}">
	<div class="panelBar">
		<div class="pages">
