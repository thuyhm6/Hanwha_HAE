...
<title><%--江苏玛特SAP薪资信息(前)--%>
	<spring:message code="pa.salary.title.sapinfopre"/>
</title>
</head>                              
<body>
   <%
		response.setHeader("Content-Type", "application/vnd.ms-excel; charset=UTF-8");
		response.setHeader("Content-Disposition", "attachment; filename=PaSapInfoPre.xls");
	    ...
	    <td>
	    	<table width="100%" border="2" align="center" cellpadding="0" cellspacing="0" 
				...
				<tr target="sid" rel="${item.SEQ}">
					...
					<td width="10%" align="center">${item.EMP_NAME }</td>
