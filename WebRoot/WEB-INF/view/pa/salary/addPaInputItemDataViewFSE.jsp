...
function addPaInputItemDataInfoFSE(form, callback) {
	var $form = $("#addPaInputItemDataInfoFormFSE");
	if (!$form.valid()) {
		return false;
	}
...
<div class="pageContent">
	<form id="addPaInputItemDataInfoFormFSE" name="addPaInputItemDataInfoFormFSE" method="post"
		action="/pa/salary/addPaInputItemDataInfoFSE?seach_PARAM_NO=${PARAM_NO}&seach_CPNY_ID=${CPNY_ID}" class="pageForm required-validate"
		onsubmit="return addPaInputItemDataInfoFSE(this, dialogAjaxDone);">
			...
			<c:if test="${paInputItemParamInfo.DISTINCT_FIELD eq 'PERSON_ID'}">
				...
				<dl>
					...
					<dd>
						...
						<a class="btnLook" href="/pa/salary/viewAddPaPersonalDataList?pageNum=1"
