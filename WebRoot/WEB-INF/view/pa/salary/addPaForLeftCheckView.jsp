...
<div class="pageContent">
	<form id="addPaForLeftCheckView" method="post" action="/pa/salary/addPaForLeftApplyCheckList" class="pageForm required-validate" 
		...
		<div class="pageFormContent nowrap" layoutH="60">
			<dl>
				...
				<dd>
					...
					<input id="APPLY_TYPE" name="APPLY_TYPE" value="224" type="hidden"></input>
					<input id="PAGE_FLAG" name="PAGE_FLAG" value="${PAGE_FLAG }" type="hidden"/>
					...
					<a class="btnLook" href="/ar/attendanceSettings/viewKeeperListOtApplyCheck?pageNum=1" lookupGroup="person"><!-- 查找带回 -->
			...
			<dl style="height:auto">
				<table>
					<tr>
						...
						<td class="td_type">
							<textarea id="CHECK_REASON" name="CHECK_REASON" rows="4" cols="50" maxlength="200"></textarea>
                        </td>
					</tr>
				</table>
			</dl>
