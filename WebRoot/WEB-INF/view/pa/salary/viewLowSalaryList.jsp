...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/pa/salary/viewLowSalaryList" method="post"
		...
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					...
					<td>
						<ait:deptList name="seach_DEPT_NO" id="viewLowSalaryList_seachDept" limit="pa"/>
						<ait:deptTreeIcon name="seach_DEPT_NO" limit="pa" id="viewLowSalaryList_seachDept" selected="${DEPT_NO}"/>
						<%--
				...
				<ul>
					<li>
						<div class="subBar">
							...
							<div class="buttonActive">
								<a class="update"
									onclick="return updateLowSalaryValidateCallback('updateLowSalaryForm',DWZ.ajaxDone,'');"
...
<div class="pageContent">
					...
					<tr target="PERSON_ID" rel="${paLowAdjust.PERSON_ID}">
						...
						<!-- 已提交才显示 -->
							<c:if
								...
								<a href="#" onclick="javascript:f_cancellowadjust(navTabAjaxDone,'${paLowAdjust.PA_MONTH}','${paLowAdjust.PERSON_ID}','${paLowAdjust.ADJUST_BEF}');">
	...
	<c:set value="/pa/salary/viewLowSalaryList"
		var="pageUrl" />
