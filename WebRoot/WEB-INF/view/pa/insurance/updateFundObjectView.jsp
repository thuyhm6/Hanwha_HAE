...
function navTabSearchFundInfo(form,callback) {	
	var $form = $("#updateFundObjectInfo");
	if (!$form.valid()) {
		return false;
	}
  	$.ajax({
...
<div class="pageContent">
	<form id="updateFundObjectInfo" method="post" action="/pa/insurance/updateFundObjectInfo" class="pageForm required-validate" 
		enctype="multipart/form-data" onsubmit="return navTabSearchFundInfo(this, dialogAjaxDone);">
