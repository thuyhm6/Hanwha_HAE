...
function validateCallbackUpdateIn(form,callback) {	
	var $form = $("#updateInsDataAffirmList");
	if (!$form.valid()) {
		return false;
	}
	var checked=false;
...
function affirmInsDataApplyCallback(form,callback,flag) {
	...
	<div class="pageHeader" style="border:1px #B8D0D6 solid">
		<form onsubmit="return divSearch(this, 'viewInsuranceInputItemDataAffirm');" 
		    id="seachInsuranceInputItemDataAffirmList" name="seachInsuranceInputItemDataAffirmList"
			action="/pa/insurance/viewInsuranceInputItemDataAffirmList?pageNum=1&seach_PARAM_NO=${PARAM_NO}" 
...
<div class="pageContent" style="border-left:1px #B8D0D6 solid;border-right:1px #B8D0D6 solid">
	...
	<c:set value="/pa/insurance/viewInsuranceInputItemDataAffirmList?seach_PARAM_NO=${PARAM_NO}&seach_CPNY_ID=${CPNY_ID}" var="pageUrl" />
