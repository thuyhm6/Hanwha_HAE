...
<div class="pageContent">
	<form method="post" action="/pa/insurance/addInsuranceInputItemParamInfo" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
			...
			<dl>
				...
				<dd>
					<select name="PARAM_ITEM_NO"  id="PARAM_ITEM_NO">
						<c:forEach items="${isInputItemList}" var="cpny">
					 		<option value="${cpny.PARAM_NO}">${cpny.PARAM_NAME}</option>
						</c:forEach>
					</select>
				</dd>
			</dl>
