...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/pa/insurance/viewInsuranceInputItem" method="post" rel="pagerForm">
		<div class="searchBar">
...
<div class="pageContent">
	...
	<c:set value="/pa/insurance/addInsuranceInputItemView" var="add_Url" />
	<c:set value="/pa/insurance/deleteInsuranceInputItemInfo?NO={sid}"
		var="delete_Url" />
	<c:set value="/pa/insurance/updateInsuranceInputItemView?NO={sid}"
		var="edit_Url" />
	...
	<table class="table" width="100%" layoutH="206">
		...
		<tbody>
			<c:forEach items="${isInputItemList}" var="item" varStatus="i">
	...
	<c:set value="/pa/insurance/viewInsuranceInputItem" var="pageUrl" />
