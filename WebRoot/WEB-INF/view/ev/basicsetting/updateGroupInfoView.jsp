...
<div class="pageContent">
	<form id="updateGroupInfoView" name="updateGroupInfoView" method="post" action="/ev/basicsetting/updateGroupInfo" 
		...
		<div class="pageFormContent nowrap" layoutH="56">
			<dl>
				...
				<dd>
					...
					<input type="text" name="TITLE" value="${item.TITLE}" class="required">
				</dd>
			</dl>
			<dl>
				<dt>说明</dt>
				<dd>
					<input type="text" name="CONTENT" value="${item.CONTENT}" class="required">
				</dd>
			</dl>
			<dl>
				<dt>父级对象:</dt>
				<dd>
					<input id="parentMenu" class="textInput" size="30" type="text" value="${item.PNAME}"  />
					<input type="hidden" id="groupNo" name="PARENT_ID" value="${item.PARENT_ID}" />
					<input type="hidden" id="groupDepth" name="DEPTH" value="${item.DEPTH}" />
				</dd>
			</dl>
			<dl>
				<dt><spring:message code="hr.viewPersonalInfo.title.ORDERTYPE"/><!--排序-->:</dt>
				<dd>
					<input type="text" name="ORDERNO" value="${item.ORDERNO}" class="textInput digits">
				</dd>
			</dl>
		</div>
		<div class="formBar">
