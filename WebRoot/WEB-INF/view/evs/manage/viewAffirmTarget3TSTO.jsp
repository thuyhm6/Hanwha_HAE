...
<div class="pageHeader">
	<form id="viewAffirmTarget1Form" onsubmit="return navTabSearch(this);" action="/evs/manage/viewAffirmTarget3TSTO" method="post" >
		<div class="searchBar">
...
<div class="pageContent">
	...
	<div style="padding-left:10px;padding-right:10px;padding-top:5px;">
		...
		<table class="evsList" width="1420px;">
			<thead>
				<tr>
					<th width="30px" rowspan="2">No.</th>
					<th width="70px" rowspan="2"><spring:message code="alert.pa.pasalarycanshu.xingming"/><!--姓名--></th>
					<th width="70px" rowspan="2"><spring:message code="ess.infoApply.EMP_ID"/><!--工号--></th>
					<th width="100px" rowspan="2"><spring:message code="org.title.dept"/><!--部门--></th>
					<th width="70px" rowspan="2"><spring:message code="org.title.POST_GRADE_NAME"/><!--职级--></th>
					<th width="70px" rowspan="2"><spring:message code="hrm.empinfo.MAIN_BUSINESS_NAME"/><!--主要业务--></th>
					<th width="70px" rowspan="2"><spring:message code="hrm.empinfo.ATTEND_DATE"/><!--入社日--></th>
					<th width="380px" colspan="5">Evaluation Result</th>
					<th width="60px" rowspan="2"><spring:message code="ess.empInfo.conduct_state"/><!--进行状态--></th>
					<th width="60px" rowspan="2"><spring:message code="evs.viewEvsParamInfoList.PINGJIABIAOLEIXING.a"/><!--评价表类型--></th>
					<th width="50px" rowspan="2"><spring:message code="ar.monthwork.title.kuanggong"/><!--旷工--></th>
					<th width="50px" rowspan="2"><spring:message code="evs.viewAffirmTarget11HTSV.BINGSHIJIA.a"/><!--病/事假--></th>
					<th width="50px" rowspan="2"><spring:message code="evs.viewAffirmTarget11HTSV.CHANBUJISHENG.a"/><!--产/哺/计生--></th>
					<th width="50px" rowspan="2"><spring:message code="evs.viewAffirmTarget11HTSV.TINGGONG.a"/><!--停工--></th>
					<th width="50px" rowspan="2"><spring:message code="evs.viewAffirmTarget11HTSV.HUNSANG.a"/><!--婚丧--></th>
					<th width="50px" rowspan="2"><spring:message code="ar.viewArAnnualStandard.title.ninjia"/><!--年假--></th>
					<th width="50px" rowspan="2"><spring:message code="ess.infoApply.LATE_TIMES"/><!--迟到次数--></th>
					<th width="50px" rowspan="2"><spring:message code="ess.infoApply.leave_early"/><!--早退--></th>
				</tr>
				<tr>
					<th width="80px"><spring:message code="evs.viewAffirmTarget11HTSV.PINGJIADENGJIYICI.a"/><!--评价等级1次--></th>
					<th width="80px"><spring:message code="evs.viewConfirmTargetInfoSST.YICIKAOHEYIJIAN.a"/><!--1次考核意见--></th>
					<th width="80px"><spring:message code="evs.viewAffirmTarget11HTSV.PINGJIADENGJIERCI.a"/><!--评价等级2次--></th>
					<th width="70px"><spring:message code="evs.viewAffirmTarget11HTSV.PINGJIADENGJISANCI.a"/><!--评价等级3次--></th>
					<th width="70px"><spring:message code="evs.viewAffirmTarget22HTSV.SANCIPINGYU.a"/><!--3 次 评语--></th>
				</tr>
			</thead>
			<tbody>
			<c:forEach items="${viewConfirmTarget}" var="item" varStatus="i">
				<tr>
					...
					<td><a href="/evs/manage/viewConfirmTargetInfoTSTO?RESUME_SEQ=${RESUME_SEQ }&EVS_OBJECT_SEQ=${item.SEQ}" target="dialog" width="800" height="600" mask="true" style="color:blue;">${item.LOCAL_NAME }</a></td>
					<td>${item.EMPID }</td>
					<td>${item.DEPTNAME }</td>
					...
					<td style="text-align:center">
						<c:if test="${item.ACTIVITY eq '14015359'}">
						...
						<c:if test="${item.ACTIVITY ne '14015359'}">
