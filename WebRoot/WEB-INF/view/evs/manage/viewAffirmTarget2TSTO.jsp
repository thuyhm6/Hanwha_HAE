...
<div class="pageHeader">
	<form id="viewAffirmTarget1Form" onsubmit="return navTabSearch(this);" action="/evs/manage/viewAffirmTarget2TSTO" method="post" >
		<div class="searchBar">
...
<div class="pageContent">
	...
	<div style="padding-left:10px;padding-right:10px;padding-top:5px;">
		...
		<table class="evsList" width="1260px;">
			<thead>
				<tr>
					...
					<th width="240px" colspan="3">Evaluation Result</th>
					<th width="70px" rowspan="2"><spring:message code="ess.empInfo.conduct_state"/><!--进行状态--></th>
					<th width="70px" rowspan="2"><spring:message code="evs.viewEvsParamInfoList.PINGJIABIAOLEIXING.a"/><!--评价表类型--></th>
				...
				<tr>
					...
					<th width="80px"><spring:message code="evs.viewAffirmTarget22HTSV.ERCIPINGYU.a"/><!--2次 评语--></th>
				</tr>
			</thead>
			<tbody>
			<c:forEach items="${viewConfirmTarget}" var="item" varStatus="i">
				<tr>
					...
					<td style="text-align:center">
						<c:if test="${item.ACTIVITY eq '14015358'}">
						...
						<c:if test="${item.ACTIVITY ne '14015358'}">
