...
<div class="pageContent">
	...
	<%-- <div style="width:35%;float:left;margin-left:10px;">
		<div style="font:bold 14px/20px arial,sans-serif;float:left;width:100%;height:20px;line-height:20px;"><spring:message code="evs.viewEvsAffirmRat.KAOQINBIAOZHUN.a"/><!--考勤标准--> </div>
