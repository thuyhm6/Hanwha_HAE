...
<div class="pageHeader">
	<form id="viewAffirmTargetForm" onsubmit="return navTabSearch(this);" action="/evs/manage/viewAffirmTarget11TSTO" method="post" >
		<div class="searchBar">
			...
			<div class="subBar">
				<ul>
					...
					<li>
						<a class="buttonActive"  onclick="downloadExcel('viewAffirmTargetForm','/disc/autoExcel/exportLOtImportExcel?SQL_SEQMEAN=182','/evs/manage/viewAffirmTarget11TSTO')">
...
<div class="pageContent">
	<div style="padding-left:10px;padding-right:10px;padding-top:5px;">
		...
		<table class="evsList" id="viewaffirmTarget_evsList" width="1400px;">
			<thead>
				<tr>
					<th width="30px">No.</th>
					<th width="90px"><spring:message code="alert.pa.pasalarycanshu.xingming"/><!--姓名--></th>
					...
					<th width="110px"><spring:message code="hrm.empinfo.MAIN_BUSINESS_NAME"/><!--主要业务--></th>
					...
					<th width="90px"><spring:message code="evs.viewConfirmTargetInfoSST.YICIKAOHEYIJIAN.a"/><!--1次考核意见--></th>
					<th width="70px"><spring:message code="ess.empInfo.conduct_state"/><!--进行状态--></th>
					<th width="60px"><spring:message code="ar.monthwork.title.kuanggong"/><!--旷工--></th>
					<th width="80px"><spring:message code="evs.viewAffirmTarget11HTSV.BINGSHIJIA.a"/><!--病/事假--></th>
					<th width="80px"><spring:message code="evs.viewAffirmTarget11HTSV.CHANBUJISHENG.a"/><!--产/哺/计生--></th>
					<th width="60px"><spring:message code="evs.viewAffirmTarget11HTSV.TINGGONG.a"/><!--停工--></th>
					<th width="60px"><spring:message code="evs.viewAffirmTarget11HTSV.HUNSANG.a"/><!--婚丧--></th>
					<th width="60px"><spring:message code="ar.viewArAnnualStandard.title.ninjia"/><!--年假--></th>
					<th width="80px"><spring:message code="ess.infoApply.LATE_TIMES"/><!--迟到次数--></th>
					<th width="60px"><spring:message code="ess.infoApply.leave_early"/><!--早退--></th>
				</tr>
			</thead>
			<tbody>
				...
				<tr>
					...
					<td style="text-align:center">
						<c:if test="${item.LIST_TYPE ne 'POT'}">
							<a href="/evs/manage/viewConfirmTargetInfoTSTO?EVS_PERSON_ID=${item.PERSON_ID }&RESUME_SEQ=${RESUME_SEQ }&EVS_OBJECT_SEQ=${item.SEQ}&ACTIVITY=14015357" target="dialog" width="800" height="600" mask="true" style="color:blue;">${item.LOCAL_NAME }</a>
						</c:if>
					...
					<td style="text-align:center">
						...
						<input type="hidden" id="evsPoint_${i.index}" sysIndex="${i.index}" name="EVS_POINT" value="${item.EVS_POINT1 }"/>
					</td>
