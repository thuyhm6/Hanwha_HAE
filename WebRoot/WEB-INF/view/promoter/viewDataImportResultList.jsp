...
function doImportInfoExport(from){
  	var $from =$(from);
  	var url ="${base}/promoter/viewDataImportResultList";
...
function doDataImport()
{
    var params = $("#viewDataExcelImportResult").serialize();
        alertMsg.confirm("确认导入总公司单台提成设置数据?",
			{
				okCall : function() {
						$.ajax( {
						type : 'post',
						cache : false,
						url : "/promoter/createDataImportResult?" + params,
...
<div class="pageHeader">
	<form id="viewDataExcelImportResult" name="viewDataExcelImportResult"
			action="/promoter/viewDataImportResultList" 
...
<div class="pageContent">	
	...
	<c:set value="/promoter/viewDataImportResultList" var="pageUrl"/>
