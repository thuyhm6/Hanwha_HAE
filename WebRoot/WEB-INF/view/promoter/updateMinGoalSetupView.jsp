...
<div class="pageContent">
	<form method="post" action="/promoter/updateMinGoalSetup" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone);">
		...
		<div class="pageFormContent nowrap" layoutH="60">
			<dl>
				<dt>大区</dt>
				<dd>${itemInfo.PAY_AREA_NM}</dd>
			</dl>
			<dl>
				<dt>产品类型</dt>
				<dd>${itemInfo.PROD_TP_NM}</dd>
			</dl>
			<dl>
				<dt>最小目标</dt>
				<dd style="width:60px"><input name="MIN_GOAL_AMT" value="${itemInfo.MIN_GOAL_AMT}" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')"/></dd>
			</dl>
			<dl>
				<dt>状态</dt>
				<dd>
