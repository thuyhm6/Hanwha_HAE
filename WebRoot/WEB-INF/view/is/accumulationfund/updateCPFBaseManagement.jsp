...
function validateCallbackeditCPFBaseManagement(form, callback) {
	...
	var $form = $("#editCPFBaseManagement");
...
<div class="pageContent">
	<form id="editCPFBaseManagement" method="post"
		action="/is/accumulationfund/editCPFBaseManagement"
		...
		<div class="formBar">
			<ul>
				...
				<li>
					<div class="button">
						<div class="buttonContent">
							<button type="button" onclick="close_bx0202();">
