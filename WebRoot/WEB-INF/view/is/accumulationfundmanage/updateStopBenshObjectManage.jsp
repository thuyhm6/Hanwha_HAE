...
function validateCallbackupdateStopBenshObjectManage(form, callback) {


	var $form = $("#updateStopBenshObjectManage1");
...
//修改关闭
function close_bx0204(){
    var url="'/is/accumulationfundManage/StopBenshObjectManageNotUpdate?pageNum=1&menuNo=124914&navTabId=bx0204','bx0204', '对象减少'";
}
</script>


<div class="pageContent">
	<form id="updateStopBenshObjectManage1" method="post"
		action="/is/accumulationfundmanage/updateStopBenshObjectManage1"
		class="pageForm required-validate"
		onsubmit="return validateCallbackupdateStopBenshObjectManage(this, dialogAjaxDone);">
		...
		<div class="formBar">
			<ul>
				...
				<li>
					<div class="button">
						<div class="buttonContent">
							<button type="button" class="close" onclick="close_bx0204();">
