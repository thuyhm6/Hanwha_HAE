...
null</td>
<td width="35%">
<input type="text" name="END_DATE" id="END_DATE"   value=""/></td>
</tr>
<tr    height= "50" onMouseOver=this.style.backgroundColor="#F7F7F7" onMouseOut=this.style.backgroundColor="FFFFFF">
	<td width="15%" align="center">
START_DATE	</td>
...
null</td>
<td width="35%">
<input type="text" name="START_DATE" id="START_DATE"   value=""/></td>
</tr>
<tr    height= "50" onMouseOver=this.style.backgroundColor="#F7F7F7" onMouseOut=this.style.backgroundColor="FFFFFF">
	<td width="15%" align="center">
LEAVE_TYPE_CODE	</td>
...
null</td>
<td width="35%">
<input type="text" name="LEAVE_TYPE_CODE" id="LEAVE_TYPE_CODE"   value=""/></td>
</tr>
<tr    height= "50" onMouseOver=this.style.backgroundColor="#F7F7F7" onMouseOut=this.style.backgroundColor="FFFFFF">
	<td width="15%" align="center">
DEPTNO	</td>
...
null</td>
<td width="35%">
<input type="text" name="POST_FAMILY" id="POST_FAMILY"   value=""/></td>
</tr>
