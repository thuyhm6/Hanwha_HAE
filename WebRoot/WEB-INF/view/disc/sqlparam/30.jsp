...
null</td>
<td width="35%">
<input type="text" name="CONFIRM_FLAG" id="CONFIRM_FLAG"   value=""/></td>
</tr>
<tr    height= "50" onMouseOver=this.style.backgroundColor="#F7F7F7" onMouseOut=this.style.backgroundColor="FFFFFF">
	<td width="15%" align="center">
FROM_DATE	</td>
...
null</td>
<td width="35%">
<input type="text" name="FROM_DATE" id="FROM_DATE"   value=""/></td>
</tr>
<tr    height= "50" onMouseOver=this.style.backgroundColor="#F7F7F7" onMouseOut=this.style.backgroundColor="FFFFFF">
	<td width="15%" align="center">
TO_DATE	</td>
...
null</td>
<td width="35%">
<input type="text" name="TO_DATE" id="TO_DATE"   value=""/></td>
</tr>
<tr    height= "50" onMouseOver=this.style.backgroundColor="#F7F7F7" onMouseOut=this.style.backgroundColor="FFFFFF">
	<td width="15%" align="center">
AFFIRM_FLAG	</td>
...
null</td>
<td width="35%">
<input type="text" name="AFFIRM_FLAG" id="AFFIRM_FLAG"   value=""/></td>
</tr>
<tr    height= "50" onMouseOver=this.style.backgroundColor="#F7F7F7" onMouseOut=this.style.backgroundColor="FFFFFF">
	<td width="15%" align="center">
EMP_TYPE_CODE	</td>
...
null</td>
<td width="35%">
<input type="text" name="SHIFT_NO" id="SHIFT_NO"   value=""/></td>
</tr>
<tr    height= "50" onMouseOver=this.style.backgroundColor="#F7F7F7" onMouseOut=this.style.backgroundColor="FFFFFF">
	<td width="15%" align="center">
adminId	</td>
...
null</td>
<td width="35%">
<input type="text" name="GROUP_ID" id="GROUP_ID"   value=""/></td>
</tr>
