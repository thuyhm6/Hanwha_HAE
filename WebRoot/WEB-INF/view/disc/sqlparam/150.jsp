...
null</td>
<td width="35%">
<input type="text" name="PAY_DATE_PRO" id="PAY_DATE_PRO"   value=""/></td>
</tr>
<tr    height= "50" onMouseOver=this.style.backgroundColor="#F7F7F7" onMouseOut=this.style.backgroundColor="FFFFFF">
	<td width="15%" align="center">
PAY_DATE	</td>
...
null</td>
<td width="35%">
<input type="text" name="PAY_DATE" id="PAY_DATE"   value=""/></td>
</tr>
<tr    height= "50" onMouseOver=this.style.backgroundColor="#F7F7F7" onMouseOut=this.style.backgroundColor="FFFFFF">
	<td width="15%" align="center">
DEPT_NO	</td>
...
null</td>
<td width="35%">
<input type="text" name="SALARY_DISTIN_NO" id="SALARY_DISTIN_NO"   value=""/></td>
</tr>
