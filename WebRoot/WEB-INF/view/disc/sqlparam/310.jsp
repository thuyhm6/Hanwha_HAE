...
null</td>
<td width="35%">
<input type="text" name="withAllatt" id="withAllatt"   value=""/></td>
</tr>
<tr    height= "50" onMouseOver=this.style.backgroundColor="#F7F7F7" onMouseOut=this.style.backgroundColor="FFFFFF">
	<td width="15%" align="center">
interCpnyID	</td>
...
null</td>
<td width="35%">
<input type="text" name="EMP_OFFICE" id="EMP_OFFICE"   value=""/></td>
</tr>
<tr    height= "50" onMouseOver=this.style.backgroundColor="#F7F7F7" onMouseOut=this.style.backgroundColor="FFFFFF">
	<td width="15%" align="center">
KEY	</td>
...
null</td>
<td width="35%">
<input type="text" name="HRGROUP_NO" id="HRGROUP_NO"   value=""/></td>
</tr>
<tr    height= "50" onMouseOver=this.style.backgroundColor="#F7F7F7" onMouseOut=this.style.backgroundColor="FFFFFF">
	<td width="15%" align="center">
adminID	</td>
