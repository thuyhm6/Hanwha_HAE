...
<script type="text/javascript">
 function checkPaMonth(){
	 var $form = $("#currentRenditionCollect");
 ...
 function  openPaPayrollCostsExecl(a){
      var $this=$(a);
      var title = $this.attr("title"); 
      var $from = $("#currentRenditionCollect");  
      
	  var url ="/report/pac03/currentRenditionCollectExcel";
...
<div class="pageHeader" style="border:1px #B8D0D6 solid">
	 <form id="currentRenditionCollect" method="post" action="/report/pac03/currentRenditionCollect">
		<div class="searchBar">
			...
			<div class="subBar">
				<ul>
		           <li>
					  <a class="button" onclick="openPaPayrollCostsExecl(this)"<%--是否导出?--%>title="<spring:message code='rp.report.title.exportYN'/>">
