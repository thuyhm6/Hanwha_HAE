...
function exportWelAmountbyEmp2(a, navTabId) {
	var suffix = $('input[name="suffix"]:checked').val();
	var report = $('input[name="reportType"]:checked').val();
	if(suffix == 'xls' && report == 'save'){
		document.getElementById("rpWelAmountbyEmpLink").innerHTML = "设置导出文件密码";
		var sform = document.getElementById("onlyForm");
		var eForm = document.getElementById("exportWelAmountbyEmp"); 
		...
		$("#rp_welAmountbyEmp").attr('href', "/sys/encryptExcel"
				+"?exportFunName=/report/pac04/exportDatilyReport2"
				+"&navTabId=rpt0102"
				+"&formId=exportWelAmountbyEmp");
		$("#rp_welAmountbyEmp").attr('width', "300");
		$("#rp_welAmountbyEmp").attr('height', "150");
		$("#rp_welAmountbyEmp").click();
...
<div class="pageHeader">
	<a id="rp_welAmountbyEmp" href="#" target="dialog" mask="true"><span
		id="rpWelAmountbyEmpLink" style="display: none"></span></a> 
	<form action="/report/pac04/exportDatilyReport2" id="onlyForm" rel="htmlReport" method="post">
		<input type="hidden" id="reportName" name="reportName" value="welAmountbyEmp" />
					...
					<li>
						<div class="buttonActive">
							<div class="buttonContent">
								<button type="button" onClick="exportWelAmountbyEmp2(this,'${param.navTabId}')">
									查询
								</button>
							</div>
						</div>
	...
	<form id="exportWelAmountbyEmp" name="exportWelAmountbyEmp" method="post">
