...
<div class="pageHeader">
	<form method="post" action="/report/pa/viewOfficeProveList" onsubmit="return dwzSearch(this,'dialog')" rel="pagerForm">
...
<div class="pageContent">
	...
	<form id="pagerForm" method="post" action="/report/pa/viewOfficeProveList">
	<div class="panelBar">
		<div class="pages">
