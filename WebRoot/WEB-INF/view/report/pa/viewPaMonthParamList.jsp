...
function exportpayPayFSE(a, navTabId) {
	...
	if(suffix == 'xls'){// --ok
		...
		$("#rp_payPayFSE").attr('href', "/sys/encryptExcel"
...
<div class="pageHeader">
	...
	<form action="/report/pac04/exportDatilyReport2" id="onlyForm" rel="htmlReport" method="post">
		<input type="hidden" id="reportName" name="reportName" value="payPayFSE${defaultCpny}" />
					...
					<li>
						<div class="buttonActive">
							<div class="buttonContent">
								<button type="button" onClick="exportpayPayFSE(this,'${param.navTabId}')">
									查询
								</button>
							</div>
						</div>
	...
	<form id="excelExportForm_PayPayFSE" name="excelExportForm_PayPayFSE" method="post">
		...
		<input type="hidden" id="reportName" name="reportName" value="payPayFSE" />
