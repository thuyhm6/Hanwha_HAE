...
<div class="pageHeader">
	...
	<form action="/report/pac04/exportDatilyReport2" id="onlyForm" rel="htmlReport" method="post">
		<input type="hidden" id="reportName" name="reportName" value="welTypeDetailList${defaultCpny}" />
				...
				<td width="10%" style="text-align:center">展示类型：</td>
					<td>
					    <select id="seach_TITLE" name="seach_TITLE" style="width:110px">
					         <option value="养老保险" <c:if test="${TITLE eq '养老保险' }">selected</c:if> >
					                                  养老保险详细
					         </option>
					         <option value="医疗保险" <c:if test="${TITLE eq '医疗保险' }">selected</c:if> >
					                                  医疗保险详细
					         </option>
					         <option value="失业保险" <c:if test="${TITLE eq '失业保险' }">selected</c:if> >
					                                  失业保险详细
					         </option>
					         <option value="工伤保险" <c:if test="${TITLE eq '工伤保险' }">selected</c:if> >
					                                  工伤保险详细
					         </option>
					         <option value="生育保险" <c:if test="${TITLE eq '生育保险' }">selected</c:if> >
					                                  生育保险详细
					         </option>
					         <option value="公积金" <c:if test="${TITLE eq '公积金' }">selected</c:if> >
					                                  公积金详细
					         </option>
					    </select>
					</td>
