...
<div class="pageHeader">
	...
	<form action="/report/pac04/exportDatilyReport2" id="onlyForm" rel="htmlReport" method="post">
		<input type="hidden" id="reportName" name="reportName" value="welRetrieveWealCheckListLGETA" />
		...
		<div class="searchBar">
			<table class="searchContent">
				<tr>
				<td width="10%" style="text-align:center">Check List：</td>
					<td>
					    <select id="seach_ITEM_NO" name="seach_ITEM_NO" style="width:200px">
					         <option value="217823" <c:if test="${ITEM_NO eq '217823' }">selected</c:if>>
					         Accumulate Fund Check List</option>
				             <option value="217821"<c:if test="${ITEM_NO eq '217821' }">selected</c:if>>
				             Medical Fund Check List</option>
				             <option value="217820"<c:if test="${ITEM_NO eq '217820' }">selected</c:if>>
				             Annuity Fund Check List</option>
				             <option value="217822" <c:if test="${ITEM_NO eq '217822' }">selected</c:if>>
				             JobLoss Fund Check List</option>
					    </select>
					</td>
					</td>
