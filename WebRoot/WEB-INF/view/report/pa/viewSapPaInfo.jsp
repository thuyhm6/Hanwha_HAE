...
<script type="text/javascript">
 function  openSapPawin(){
     var $form = $("#viewSapPaInfo");
     ...
     if(checkSapPa()==true){
     	 window.document.getElementById("onSapPa").href="/report/pa/viewSapPaList?pageNum=1&seach_DEPTNO="+deptno
	     		+"&seach_YEAR="+year+"&seach_MONTH="+month;
     }else{
    	 window.document.getElementById("onSapPa").href="/report/pa/viewSapPaError";
     }
 }
 function checkSapPa(){
	 var $form = $("#viewSapPaInfo");
 ...
 function  openSapPaExecl(a){
    ...
    var month = $form.find("#seach_MONTH").val();
  	...
  	var url ="/report/pa/viewSapPaExcel";
	if(checkSapPa()==true){
...
<div class="pageHeader" style="border:1px #B8D0D6 solid">
	 <form id="viewSapPaInfo" method="post" action="/report/pa/viewSapPaList">
		<div class="searchBar">
			...
			<div class="subBar">
				<ul>
					<%--此功能已完成,未开放而已,使用时,开放即可 
					<li>
						<a class="button" id="onSapPa" onclick="openSapPawin()" target="dialog" width="1200" height="420" fresh="false">
					 		<span>检索--%><%--<spring:message code="public.title.search"/></span></a>
					</li>
					--%>
		           	<li>
					  	<a class="button" onclick="openSapPaExecl(this)"  <%--是否导出?--%> title="<spring:message code='rp.report.title.exportYN'/>">
