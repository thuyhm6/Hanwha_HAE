...
<script type="text/javascript">
 ...
 function  openPaTranserExcel(a){
      var $this=$(a);
      var title = $this.attr("title"); 
      var $from = $("#viewPaPayOffTranserInfo");  
      
	  var url ="/report/pac04/viewPaPayOffStatusByMonthTranserExcel";
...
<div class="pageHeader" style="border:1px #B8D0D6 solid">
	 <form id="viewPaPayOffTranserInfo" method="post" action="/report/pa/viewPaTranserList">
		<div class="searchBar">
			...
			<div class="subBar">
				<ul>
		           <li>
					  <a class="button" onclick="openPaTranserExcel(this)"  <%--是否导出?--%> title="<spring:message code='rp.report.title.exportYN'/>">
