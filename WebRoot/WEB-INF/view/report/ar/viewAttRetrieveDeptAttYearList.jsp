...
<script type="text/javascript">
	...
	var sform = document.getElementById("onlyFormNDBMJB");
...
<div class="pageHeader">
	...
	<form action="/report/pac04/exportDatilyReport" id="onlyFormNDBMJB" rel="deptMon" method="post">
	<input type="hidden" id="reportName" name="reportName" value="attRetrieveDeptAttYear" />
					...
					<td>
						<select name="CPNY_ID" disabled="disabled">
							<c:forEach items="${companyList}" var="item" varStatus="i">
								<option value="attRetrieveDeptAttYear${item.CPNY_ID}"
