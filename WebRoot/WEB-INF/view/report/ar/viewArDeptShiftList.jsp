...
<script type="text/javascript">
 function  openPaTranserExecl(a){
     ...
     var $form = $("#viewArDeptShiftList");  
     
	  var url ="/report/ar/viewArDeptShiftListTranserExcel";
...
<div class="pageHeader" style="border:1px #B8D0D6 solid">
	 <form id="viewArDeptShiftList" method="post" action="/report/hr/viewPersonRecodeList">
		<div class="searchBar">
