...
--%> 
 ...
 function  openPaPayrollCostsExecl(a){
      ...
      var $from = $("#viewPaPayrollCostsInfo");  
      
	  var url ="/report/pac01/viewPaPayrollCostsExcel";
	  if(checkPaMonth()==true){
...
<div class="pageHeader" style="border:1px #B8D0D6 solid">
	 <form id="viewPaPayrollCostsInfo" method="post" action="/report/pac01/viewPaPayrollCostsList">
		<div class="searchBar">
