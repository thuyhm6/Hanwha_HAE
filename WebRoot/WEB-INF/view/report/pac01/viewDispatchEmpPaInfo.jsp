...
<script type="text/javascript">
 function checkDispatchEmpPaPaMonth(){
	 var $form = $("#viewDispatchEmpPaInfo");
 ...
 function  openDispatchEmpPaExecl(a){
      var $this=$(a);
      var title = $this.attr("title"); 
      var $from = $("#viewDispatchEmpPaInfo");  
      
	  var url ="/report/pac01/viewDispatchEmpPaExcel";
	  if(checkDispatchEmpPaPaMonth()==true){
...
<div class="pageHeader" style="border:1px #B8D0D6 solid">
	 <form id="viewDispatchEmpPaInfo" method="post" action="/report/pac01/viewDispatchEmpPaInfo">
		<div class="searchBar">
			...
			<div class="subBar">
				<ul><%-- 
		           ...
		           <li>
					  <a class="button" onclick="openDispatchEmpPaExecl(this)"<%--是否导出?--%>title="<spring:message code='rp.report.title.exportYN'/>">
