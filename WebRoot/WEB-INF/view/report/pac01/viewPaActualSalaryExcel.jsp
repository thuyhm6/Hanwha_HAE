	    ...
	    <td>
	    	<table width="100%" border="2" align="center" cellpadding="0" cellspacing="0" 
				...
				<tr>
					...
					<td align="center"><%--病假付薪--%>
						病假付薪
					</td>
					<td align="center"><%--产假付薪--%>
						产假付薪
					</td><%--
					<td align="center">工伤付薪
						工伤付薪
					</td>--%>
					<td align="center"><%--午餐费--%>
						误餐费
					...
					<td align="center"><%--停职扣款--%>
						停职扣款
					</td>
					<td align="center"><%--旷工扣款--%>
						旷工扣款
					</td>
					<td align="center"><%--未勤扣款--%>
						未勤扣款
					</td>
					<td align="center"><%--迟到扣款--%>
						迟到扣款
					</td>
					<td align="center"><%--早退扣款--%>
						早退扣款
					</td>
		       	...
		       	<c:forEach items="${actualSalaryList}" var="pa" varStatus="i">
					<tr>
						...
						<td style="text-align: right">
							<fmt:formatNumber value="${pa.RESIDENT_OUTSIDE_ALLOWANCE }" pattern="#,##0.00#"/>
						</td>
						...
						<td style="text-align: right">
							<fmt:formatNumber value="${pa.SICK_LEAVE_PAYROLL }" pattern="#,##0.00#"/>
						</td>
						<td style="text-align: right">
							<fmt:formatNumber value="${pa.MATERNITY_LEAVE_SALARY }" pattern="#,##0.00#"/>
						</td><%-- 
						<td style="text-align: right">
							<fmt:formatNumber value="${pa.HERT_WORK_SALARY }" pattern="#,##0.00#"/>
						</td>--%>
						<td style="text-align: right">
						...
						<td style="text-align: right">
							<fmt:formatNumber value="${pa.OTHER_ALLOWANCE_TOTAL }" pattern="#,##0.00#"/>
						</td>
						<td style="text-align: right">
							<fmt:formatNumber value="${pa.BEFORE_TAXABLE_PAY_PLUS }" pattern="#,##0.00#"/>
						</td>
						<td style="text-align: right">
							<fmt:formatNumber value="${pa.BEFORE_TAXABLE_PAY_DEDUCT }" pattern="#,##0.00#"/>
						</td>
						<td style="text-align: right">
						...
						<td style="text-align: right">
							<fmt:formatNumber value="${pa.BANDH_DEDUCTIONS }" pattern="#,##0.00#"/>
						</td>
						<td style="text-align: right">
							<fmt:formatNumber value="${pa.ABSENTEEISM_DEDUCTIONS }" pattern="#,##0.00#"/>
						</td>
						<td style="text-align: right">
							<fmt:formatNumber value="${pa.NO_FREQUENTLY_DEDUCTIONS }" pattern="#,##0.00#"/>
						</td>
						<td style="text-align: right">
							<fmt:formatNumber value="${pa.TARDINESS_DEDUCTIONS }" pattern="#,##0.00#"/>
						</td>
						<td style="text-align: right">
							<fmt:formatNumber value="${pa.EARLYDAY_DEDUCTIONS }" pattern="#,##0.00#"/>
						</td>
