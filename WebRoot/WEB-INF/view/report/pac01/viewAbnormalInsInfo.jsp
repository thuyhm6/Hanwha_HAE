...
--%> 
 ...
 function  openAbnormalInsExecl(a){
      var $this=$(a);
      var title = $this.attr("title"); 
      var $from = $("#viewAbnormalInsInfo");  
      
	  var url ="/report/pac01/viewAbnormalInsExcel";
	  if(checkPaMonth()==true){
...
<div class="pageHeader" style="border:1px #B8D0D6 solid">
	 <form id="viewAbnormalInsInfo" method="post" action="/report/pac01/viewAbnormalInsInfo">
		<div class="searchBar">
			...
			<div class="subBar">
				<ul><%-- 
		           ...
		           <li>
					  <a class="button" onclick="openAbnormalInsExecl(this)"<%--是否导出?--%>title="<spring:message code='rp.report.title.exportYN'/>">
