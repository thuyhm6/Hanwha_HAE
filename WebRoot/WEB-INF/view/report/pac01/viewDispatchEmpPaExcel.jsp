	    	...
	    	<table width="100%" border="2" align="center" cellpadding="0" cellspacing="0" 
	    		...
	    		<tr>
		    		<td align="center" colspan="50" >
		    			<b><font size="+2">乐天玛特${YEAR }年${MONTH }月，外派人员薪资信息</font></b>
		    		</td>
		    	</tr>
		    	<tr>
					...
					<td style="text-align: center" colspan="24"><%--单位部分社保--%>
						单位部分社保
					</td>
					<td style="text-align: center" colspan="18"><%--个人部分社保--%>
						个人部分社保
					</td>
				...
				<tr>
					...
					<td style="text-align: center" colspan="2"><%--单位补缴--%>
						单位补缴
					</td>
					...
					<td style="text-align: center" colspan="2"><%--个人补缴--%>
						个人补缴
					</td>
				...
				<tr>
				    ...
				    <td style="text-align: center"><%--单位社保补缴--%>
						单位社保补缴
					</td>
					<td style="text-align: center"><%--单位公积金补缴--%>
						单位公积金补缴
					</td>
				    ...
				    <td style="text-align: center"><%--社保补缴--%>
						个人社保补缴
					</td>
					<td style="text-align: center"><%--公积金补缴--%>
						个人公积金补缴
					</td>
				</tr>        
		       	<c:forEach items="${dispatchEmpPaList}" var="pa" varStatus="i">
					<tr>
						...
						<td style="text-align: right"><%--社保合计--%>
							<fmt:formatNumber value="${pa.SOCIAL_SECURITY_TOTAL}" pattern="#,##0.00#"/>
						</td>
					</tr>
				</c:forEach>
	      </table>  
