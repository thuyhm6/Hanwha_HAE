...
<script type="text/javascript">
 ...
 function showSheet(){
	  ...
	  var seach_emp_type_code = document.getElementById("seach_emp_type_code").value;
	 
	 document.getElementById("reportpdf").href='/report/pac11/jasperServlet?reportName=palist&pamonth='+year+month+'&deptid='+deptid+'&empid='+seach_EMPID+'&emp_type_code='+seach_emp_type_code ;
		...
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					...
					<td width="5%" style="text-align:right"><spring:message code="hr.viewPersonalInfo.title.EMP_TYPE_NAME" />
								<!--员工类型-->：
					</td>
					<td width="8%" style="text-align:center">
					    <ait:SelectSyCodeByCpnyID name="seach_emp_type_code" parentNo="1368"
