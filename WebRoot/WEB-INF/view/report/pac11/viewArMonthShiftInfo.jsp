...
function  openPaTranserExecl(a){
    ...
    var $form = $("#viewArMonthShiftInfo");  
  	var deptid = document.getElementById("startDept12").value; //alert(deptid);
	  var url ="/report/pac11/viewArMonthShiftInfoTranserExcel?DEPTID="+deptid
...
<div class="pageHeader" style="border:1px #B8D0D6 solid">
	 <form id="viewArMonthShiftInfo" method="post" action="/report/pa/viewPaTranserList">
		<div class="searchBar">
				...
				<tr>
					...
					<td width="25" style="text-align:left">
						<select id="seach_YEAR" name="seach_YEAR" style="width:75px">
							<c:forEach var="i" begin="2008" end="2020" step="1"> 
