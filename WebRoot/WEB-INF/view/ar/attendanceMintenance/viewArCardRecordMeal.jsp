...
function insertMacRecordMealList(form,callback){
    var $form=null;
	if($('#'+form).length>0)
		$form=$('#'+form);
	else
    ...
    $.ajax({
		...
		url: "/ar/attendanceMintenance/insertMacRecordMealList?STIME="+STIME_FORMAT+"&RTIME="+RTIME_FORMAT+"&EMPID="+EMPID,
...
<div class="pageHeader">
	<form id="viewarcardrecordForm" onsubmit="return navTabSearch(this);" action="/ar/attendanceMintenance/viewArCardRecordMeal" method="post">
...
<div class="pageContent">
	<div class="formBar">
		<ul class="toolBar">
			<li>	            
				<a class="buttonActive" id="insertMacRecordMealList" onclick="insertMacRecordMealList('viewarcardrecord',DWZ.ajaxDone)" href="#"><span><!-- 读取刷卡记录 --><spring:message code="ess.infoApply.getcardinfo"/></span></a> 
			</li>		
			<li>	            
				<a class="buttonActive" id="insertMacRecordMealList_search" href="#"><span><!-- 查询 --><spring:message code="hrm.empinfo.QUERY"/></span></a> 
			</li>	
			<li><a class="buttonActive" onclick="downloadExcel('viewarcardrecordForm','/disc/autoExcel/exportLOtImportExcel?SQL_SEQMEAN=348&firstFlag=N','/ar/attendanceMintenance/viewArCardRecordMeal?firstFlag=N')">
	...
	<table class="list" width="99%">
		<thead>
			<tr>
				...
				<th width="10%"><!--日期 -->Day</th>
				<th width="10%"><!--日期 --><spring:message code="ess.infoApply.attendance_date"/></th>
				...
				<th width="10%">Gate</th>
				<th width="10%"><!-- Meal type --><spring:message code="inct.salesman.classify"/></th>
			</tr>
		</thead>
		<tbody>
