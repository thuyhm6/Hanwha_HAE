...
<div class="pageHeader">
	<form method="post" action="/ar/attendanceMintenance/viewDailyDetailList" onsubmit="return dwzSearch(this,'dialog')" rel="pagerForm">
...
<div class="pageContent">
			...
			<tr>
				...
				<td>
					<a class="btnSelect" 
						href="javascript:
							$.bringBack({
								person_id_dailydetail:'${keeper.PERSON_ID}',
								empId_dailydetail:'${keeper.EMPID}',
								cpny_id_dailydetail:'${keeper.CPNY_ID}',
								STAT_NO_dailydetail:'${keeper.STAT_NO}'
	...
	<form id="pagerForm" method="post" action="/ar/attendanceMintenance/viewDailyDetailList">
	<div class="panelBar">
		<div class="pages">
