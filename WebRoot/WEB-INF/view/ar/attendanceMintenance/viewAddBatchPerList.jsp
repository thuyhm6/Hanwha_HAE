...
<div class="pageHeader">
	<form method="post" action="/ar/attendanceMintenance/viewAddBatchPerList" onsubmit="return dwzSearch(this,'dialog')" rel="pagerForm">
	...
	<div class="searchBar">
		...
		<tr>
						<td>员工类型 </td>
						<td>
						  <ait:SelectSyCodeByCpnyID id="viewAddAffirmList_seach_EmpTypeCodeNo" name="seach_EmpTypeCodeNo" parentNo="13864" selected="${EmpTypeCodeNo}" cnpyID="${LoginUser.cpnyId}" limit="all"/>
						</td>
		          </tr>
		</table>
		<div class="subBar">
...
<div class="pageContent">
					...
					<a class="btnSelect" 
						href="javascript:
							$.bringBackById({
								...
								${empid}:'${keeper.EMPID}',
								${cpnyid}:'${keeper.CPNY_ID}',
								${DEPTNAME}:'${keeper.DEPT_NAME}',
								${GROUP_ID}:'${keeper.GROUP_ID}',
								${GROUP_NAME}:'${keeper.GROUP_NAME}'
	...
	<form id="pagerForm" method="post" action="/ar/attendanceMintenance/viewAddBatchPerList">
	<div class="panelBar">
		<div class="pages">
