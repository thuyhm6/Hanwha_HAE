...
<div class="pageContent">
	<form method="post" action="/ar/attendanceSettings/updateDynamicGroup" class="pageForm required-validate" onsubmit="return f_save(this);">
		<div class="pageFormContent nowrap" layoutH="65">
			<input type="hidden" name="NO" value="${dynamicGroup.GROUP_NO}"/>
			
			<ait:SyLanguage languageNo="${dynamicGroup.GROUP_NO}"/>
			...
			<dl style="height:auto;">
				<table>
					<tr>
						...
						<td class="td_type"><textarea name="DESCRIPTION" cols="60" rows="2">${dynamicGroup.DESCRIPTION}</textarea></td>
					</tr>
				</table>
			</dl>			
			</div>
