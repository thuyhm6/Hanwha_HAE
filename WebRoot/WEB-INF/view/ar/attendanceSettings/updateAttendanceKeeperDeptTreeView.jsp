		...
		try {
			...
			for(int i = 0 ; i < listSize ; ++i){
				...
				if(deptMap.get("childDeptList") != null){
					...
					out.print("<li><a tname=\"DEPTNO\" tvalue=\"" + deptMap.get("DEPTNO") + "\" " + checked + ">" + deptMap.get("DEPT_NAME") + "</a><ul>") ;
					...
					out.print("<li><a tname=\"DEPTNO\" tvalue=\"" + deptMap.get("DEPTNO") + "\" " + checked + ">" + deptMap.get("DEPT_NAME") + "</a></li>") ;	
				}
			}
...
<div id="keeperDeptTree"  class="panel" style="display:block;float:right;clear:none; width:48%;min-width:300px;" >	
	...
	<div class="pageFormContent nowrap" style="overflow:auto" layoutH="90">
		...
		<ul class="tree treeFolder treeCheck expand" >
				...
				List keeperDeptList = (List)request.getAttribute("attendanceKeeperDeptList") ;
				
				this.writeDeptTree(out , keeperDeptList) ;
			
		</ul>
		--%>
		<ul id="deptTree_updateattendancekeeperdepttree" class="ztree" layoutH="100"></ul>
