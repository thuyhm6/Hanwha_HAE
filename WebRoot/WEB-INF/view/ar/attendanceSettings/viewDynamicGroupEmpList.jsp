...
<div class="pageHeader">
	<form name="subForm1" onsubmit="return navTabSearch(this);" action="/ar/attendanceSettings/viewDynamicGroupEmpList?NO=${param.NO }&pageNum=1" method="post"  rel="pagerForm">
		<div class="searchBar" >
		 ...
		 <ait:SelectSyCodeByCpnyID id="seach_EmpOffice" name="seach_EmpOffice" parentNo="15118" selected="${EmpOffice}" cnpyID="${LoginUser.cpnyId}" limit="all"/>
						...
						<!--<td><spring:message
										code="hrm.recruitManage.Wage_type" /> 工资类型 </td>
						<td >
						<ait:SelectSyCodeByCpnyID
							name="WAGE_TYPE" selected="${expInfo.WAGE_TYPE}"
							parentNo="14643"
							limit="all" />
						</td>-->
				</tr>
...
<div class="pageContent">
	<form name="subForm2" onsubmit="return validateCallback2(this, navTabAjaxDone);" class="pageForm required-validate" 
		 action="/ar/attendanceSettings/addDynamicGroupPerson" method="post" rel="pagerForm">
	...
	<table class="table" width="100%" layoutH="206">
		...
		<tbody>
			<c:forEach items="${dynamicGroupEmpList}" var="list" varStatus="i">
	...
	<c:set value="/ar/attendanceSettings/viewDynamicGroupEmpList?KEY=${KEY}&DEPTNO=${DEPTNO}" var="pageUrl"/>
