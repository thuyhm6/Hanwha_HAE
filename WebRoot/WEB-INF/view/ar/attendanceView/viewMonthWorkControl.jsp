...
function exceptMonthWorkExcle(){
	...
	obj.action = "/ar/attendanceView/viewMonthWorkControlExcel";
	obj.submit();
}
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/ar/attendanceView/viewMonthWorkControl" method="post" rel="pagerForm" id="dataForm">
		<div class="searchBar">
				...
				<tr>
				  <td>在职状态</td>
				 	...
				 	<ait:SelectSyCodeByCpnyID id="seach_EmpOffice" name="seach_EmpOffice" parentNo="15118" selected="${EmpOffice}" cnpyID="${LoginUser.cpnyId}" limit="all"/>
						...
						<td>人员类型组 </td>
						<td>
							<input type="hidden" id="ar0115_limit" name="limit" value="ar">
							<input type="hidden" id="ar0115_seach_CPNY" name="seach_CPNY" value="${LoginUser.cpnyId}">
							<ait:SelectEmpTypeCode  id="ar0115_seach_JobTypeGroupNo"  name="seach_JobTypeGroupNo" selected="${JobTypeGroupNo}" limit="ar" type="group"
								onChangeName="ajaxEmpTypeForGroupToList(-1,ar0115_seach_JobTypeGroupNo,ar0115_seach_EmpTypeCodeNo,ar0115_seach_CPNY,ar0115_limit)"/>
						</td>
						<td>人员类型 </td>
						<td>
		 					<ait:SelectEmpTypeCode id="ar0115_seach_EmpTypeCodeNo" name="seach_EmpTypeCodeNo" selected="${EmpTypeCodeNo}" limit="ar"/>
						</td>	
				</tr>
				<tr>
					<td>
...
<table class="table" layoutH="253">
	<thead>
		<tr>
			...
			<th align="center" width="10%" ><%--开始日期--%><spring:message code="ar.viewcycleparameter.title.kaishiriqi"/></th>
			<th align="center" width="10%" ><%--结束日期--%><spring:message code="ar.viewcycleparameter.title.jieshuriqi"/></th>
			<th align="center" width="70" >${controlMap[ITEM1]}<spring:message code="ar.attendanceview.paiming"/></th>
	...
	<c:set value="/ar/attendanceView/viewMonthWorkControl" var="pageUrl" />
