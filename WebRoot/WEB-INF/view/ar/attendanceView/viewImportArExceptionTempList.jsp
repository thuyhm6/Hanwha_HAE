...
<div class="pageHeader">
	<form id="viewImportArExceptionTempList" name="viewImportArExceptionTempList"
			action="/ar/attendanceView/viewImportArExceptionTempList" 
...
<div class="pageContent">
	...
	<table class="table" width="100%" layoutH="220" nowrapTD="false">
		...
		<tbody>
			<c:forEach items="${paArExceptionTempList}" var="item" varStatus="i">			
				<tr>
	...
	<c:set value="/ar/attendanceMintenance/viewImportArExceptionTempList" var="pageUrl"/>
