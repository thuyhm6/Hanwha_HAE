...
dTree.prototype.openUsedDom = function() {
	this.oUDom(true);
}
dTree.prototype.openEmptyDom = function() {
	this.oEDom(true);
}
...
dTree.prototype.oUDom = function(status) {
	for (var n=0; n<this.aNodes.length; n++) {
		if (this.aNodes[n]._hc && this.aNodes[n].pid != this.root.id) {
			this.nodeStatus(status, n, this.aNodes[n]._ls)
			this.aNodes[n]._io = status;
...
dTree.prototype.oEDom = function(status) {
	for (var n=0; n<this.aNodes.length; n++) {
		if (this.aNodes[n]._hc && this.aNodes[n].pid != this.root.id) {
			this.nodeStatus(status, n, this.aNodes[n]._ls)
			this.aNodes[n]._io = status;
