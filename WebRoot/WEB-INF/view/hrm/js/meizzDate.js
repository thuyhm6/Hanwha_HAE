...
document.writeln('<iframe id=meizzDateLayer Author=wayx frameborder=0 style="position: absolute; width: 144; height: 204; z-index: 9998; display: none"></iframe>');
strFrame='<style>';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=160 bordercolor=#cdcdcd bgcolor=#cdcdcd Author="wayx">';
...
strFrame+='      <tr align=center Author="wayx"><td width=16 align=center bgcolor=#cdcdcd style="font-size:12px;cursor: hand;color: #EFEFEF" ';
...
strFrame+='        <td width=16 bgcolor=#cdcdcd align=center style="font-size:12px;cursor: hand;color: #EFEFEF" ';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 bgcolor=#cdcdcd ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
strFrame+=' BORDERCOLORLIGHT=#cdcdcd BORDERCOLORDARK=#FFFFFF width=140 height=20 Author="wayx" style="cursor:' + (bMoveable ? 'move':'default') + '">';
...
strFrame+='<td style="font-size:12px;color:#FFFFFF" Author=meizz>五</td><td style="font-size:12px;color:#00CC00" Author=meizz>六</td></tr>';
strFrame+='</table></td></tr><!-- Author:F.R.Huang(meizz) http://www.meizz.com/ mail: meizz@hzcnc.com 2002-10-8 -->';
strFrame+='  <tr Author="wayx"><td width=142 height=120 Author="wayx">';
strFrame+='    <table border=1 cellspacing=2 cellpadding=0 BORDERCOLORLIGHT=#cdcdcd BORDERCOLORDARK=#FFFFFF bgcolor=#EFEFEF width=140 height=120 Author="wayx">';
