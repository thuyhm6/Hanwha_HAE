...
<div class="pageContent">				
	<div class="pageFormContent" layoutH="56">
	    ...
	    <table id="info" border='1' width="100%" 
	    	...
	    	<tr>
		    	<td width="10%"><spring:message code="hr.viewPersonalInfo.title.EMPID" /><!-- 社号 --></td>
		    	<td width="15%">
		    	     ${person.EMPID }
		    	</td>
		    	<td width="10%"><spring:message code="hr.viewPersonalInfo.title.GRADE_LEVEL_NAME" /><!--职等--></td>
		    	<td  width="15%">
		    		${person.GRADE_LEVEL_NAME }&nbsp;
		    	</td>
		    	<td width="10%"><spring:message code="hr.viewPersonalInfo.title.DEPTNAME"/><!--部门--></td>
		    	<td  width="15%">
		    		${person.DEPTNO_NAME}
		    	</td>
		    	<td  width="15%"><spring:message code="hr.viewPersonalInfo.title.EMPLOYMENT_TYPE"/><!--雇佣类型--></td>
		    	<td  width="15%">
		    		${person.EMPLOYMENT_NAME}
		    	</td>
		    </tr>
		    <tr>
		    	<td width="150"><spring:message code="hr.viewHire.title.LOCALNAMEANDPINYIN"/><!--姓名  (拼音)--></td>
		    	<td >
                   ${person.LOCAL_NAME}(&nbsp;${person.CHINESE_PINYIN}&nbsp;)&nbsp;
				</td>
				<td width="150"><spring:message code="hr.viewPersonalInfo.title.DUTY_NAME"/><!--职责--></td>
		    	<td >
		    		${person.DUTY_NAME}&nbsp;    				    		
		    	</td>
		    	<td width="150"><spring:message code="hr.viewPersonalInfo.title.ENTRY_DATE"/><!--入司日期  --></td>
		    	<td >
		    		${person.JOIN_COMPANY_DATE}&nbsp; 
		    	</td>
		    	<td width="150"><spring:message code="hr.viewPersonalInfo.title.CONTRACT_TYPE"/><!--契约类型--></td>
		    	<td >
		    		${person.CONTRACT_NAME }&nbsp; 
		    	</td>
		    </tr>	
		    <tr>
		    	<td width="10%"><spring:message code="hr.viewPersonalInfo.title.IDCARD_NO" /><!--身份证号--></td>
		    	<td width="10%">
	                ${person.IDCARD_NO}&nbsp;
		    	</td>
		    	<td width="150"><spring:message code="hr.viewPersonalInfo.title.POST_GRADE_NAME" />
								<!--职级(GGS)--></td>
		    	<td >
		    		${person.POST_GRADE_NAME}&nbsp;
		    	</td>
		    	<td><spring:message code="liang.hr.viewPersonalInfo.title.PARTICULAR_HUMAN_DISTINGUISH"/><!--详细人力区分 --></td>
		    	<td>
					${person.EMP_TYPE_NAME }
		    	</td>
		    	<td><spring:message code="hr.viewPersonalInfo.title.WORKING_TIME"/><!--工时制--></td>
		    	<td>
					${person.WORKING_TIMET_NAME }
		    	</td>
		    </tr>	
		    <tr>
		    	<td width="width="100""><spring:message code="hr.viewPersonalInfo.title.SEX" /><!--性别--></td>
		    	<td>
		    		${person.SEX_NAME}
 		    	</td>
 		    	<td width="150"><spring:message code="hr.viewPersonalInfo.title.POST_NAME" /><!--职级名称--></td>
		    	<td >
		    		${person.POST_NAME}&nbsp;
		    	</td>
 		    	<td width="150"><spring:message code="hr.viewPersonalInfo.title.DOB" /><!--出生日期--></td>
		    	<td >
					${person.DOB}
				</td>
		    	<td width="150"></td>
				...
				<tr>
					...
					<td>
						<c:if test="${LoginUser.cpnyId ne 'HAE'}">
							<spring:message code="hrm.empinfo.SAFE_TYPE_CODE_NAME" /><!--保险类型-->
						</c:if>
