   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge" >
    ...
    function f_initGrid()
    {
    	$grid = $("#transfer").ligerGrid({
    		...
    		{ display: '再分配事由', name: 'REASON',width:270 }
            ],
            enabledEdit: true,
            dataAction: 'server', 
            sortName: 'EMPID',
            pageSize: 10,
            url: '/hrm/transferOrder/getTransferOrderList?suspendz=1',
            width: '100%', 
            height: '400'
        });
    }
    ...
    function search(){
		$("#l-search").hide();
		$.ligerWindow.show( { url:'/hrm/transferOrder/searchEmp?type=suspendz',
	...
	function save(){
		...
		if(flag == 0){
            ...
            var options = {	                        
            url:'/hrm/transferOrder/saveTransferOrder?type=suspendz',
            type:'POST',	                        
            success: function(){
...
<body style="padding:5px" >
		...
		<div id="mainBody">
			...
			<form id="applyForm">
			   	...
			   	<input type="hidden" name="TRANSCODE" value="BandhType0040">
		   	</form>       
      	</div>
