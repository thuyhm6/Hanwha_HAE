...
<div class="pageHeader">
	<form id="viewTrainingExcelImportResult" name="viewTrainingExcelImportResult"
			action="/hrm/empinfo/viewImportTrainingDataList" 
...
<div class="pageContent">	
	...
	<div class="formBar">
		...
		<li><a class="buttonActive"
			href="/hrm/empinfo/downloadWorkExperienceExcelTemplateByExcelData?type=training"><span>
			...
			href="/hrm/empinfo/submitImportExcelWorkExperienceData?accrual=training"  title="确定要提交吗?"><span>
		...
		<tbody>
			<c:forEach items="${itemList}" var="item" varStatus="i">			
				<tr>
					...
					<td class='td_center'>${item.MUST_CODE}</td>
					...
					<td class='td_center'>${item.INSTITUTION_NAME}</td>
	...
	<c:set value="/hrm/empinfo/viewImportTrainingDataList" var="pageUrl"/>
