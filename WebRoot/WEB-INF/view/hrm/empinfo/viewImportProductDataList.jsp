...
<div class="pageHeader">
	<form id="viewProductExcelImportResult" name="viewProductExcelImportResult"
			action="/hrm/empinfo/viewImportProductDataList" 
...
<div class="pageContent">	
	...
	<div class="formBar">
		...
		<li><a class="buttonActive"
			href="/hrm/empinfo/downloadWorkExperienceExcelTemplateByExcelData?type=product"><span>
			...
			href="/hrm/empinfo/submitImportExcelWorkExperienceData?accrual=product"  title="确定要提交吗?"><span>
		...
		<tbody>
			<c:forEach items="${itemList}" var="item" varStatus="i">			
				<tr>
					...
					<td class='td_center'>${item.PRODUCT_NO}</td>
	...
	<c:set value="/hrm/empinfo/viewImportProductDataList" var="pageUrl"/>
