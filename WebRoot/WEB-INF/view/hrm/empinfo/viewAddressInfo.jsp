...
<div class="pageContent">
	<!-- 地址信息 -->
	<form id="viewAddressInfo" method="post" action="/hrm/empinfo/addAddressInfo" class="pageForm required-validate" onsubmit="return validateCallbackViewFamilyInfo(this, dialogAjaxDone);">
		...
		<div class="pageFormContent" layoutH="56">
		   	<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="user_table margin_b">
				...
				有效开始日期	<!--姓名-->
					...
					<td class="td_type" width="35%">
						<input type="text"  name="EFFECTIVE_START_DATE" class="date required" readonly="true" format="yyyy-MM-dd" yearstart="-50" yearend="5" onClick="setdate(this);"/>
					</td>
