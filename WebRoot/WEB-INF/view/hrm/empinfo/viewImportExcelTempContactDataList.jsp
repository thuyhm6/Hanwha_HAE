...
<div class="pageHeader">
	<form id="viewEvalDataExcelImportResult" name="viewEvalDataExcelImportResult"
			action="/hrm/empinfo/viewImportExcelTempContactDataList" 
...
<div class="pageContent">	
	...
	<div class="formBar">
		<ul>			
			...
			href="/hrm/empinfo/downloadInfoByExcelData11?type=3"><span>
			...
			href="/hrm/empinfo/submitImportInfoExcelTempData?accrual=contact"  title="确定要提交吗?"><span>
	...
	<table class="table" width="100%" layoutH="220" nowrapTD="false">
		...
		<tbody>
			<c:forEach items="${paTempContactTempList}" var="item" varStatus="i">			
				<tr>
					<td class='td_center'>${item.LINE_ID}</td>
					<td class='td_center'>${item.FAMILY_NO}</td>
					<td class='td_center'>${item.PERSON_ID}</td>
					<td class='td_center'>${item.FAM_TYPE_CODE}</td>
	...
	<c:set value="/hrm/empinfo/viewImportExcelTempContactDataList" var="pageUrl"/>
