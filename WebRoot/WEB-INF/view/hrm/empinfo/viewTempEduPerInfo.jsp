...
function isIdCardNo(){
	...
	if (len == 15){
		...
		$("#TEMP1_IDCARD_NO").focus();
		return false;
	}else {
		//alert("输入的数字位数不对！"); 
		alertMsg.error('身份证号输入的数字位数不对！');
		$("#TEMP1_IDCARD_NO").focus();
		return false;
	}
	var a = num.match(re);
	...
	if (a != null){
		...
		if (!B){
			...
			alertMsg.error("输入的身份证号 "+ a[0] +" 里出生日期不对！");
			$("#TEMP1_IDCARD_NO").focus();
			return false;
		}else{
			$("#TEMP1_DOB").val(D.getFullYear()+"-"+((D.getMonth()+1) < 10 ? "0"+(D.getMonth()+1) : (D.getMonth()+1))+"-"+((D.getDate()) < 10 ? "0"+(D.getDate()) : (D.getDate())));
			return true;
		}
	}else{
		//您输入的身份证号不正确
...
<div class="pageContent" style="position:absolute; height:576px; overflow-y:auto">
	<form method="post" action="/hrm/empinfo/editTempEduPerInfo" class="pageForm required-validate"
		...
		<div>
			...
			<tr>
				...
				<tr>
					...
					<td class="td_type">
						<input type="text" id="PROB_PAY_RAT" name="PROB_PAY_RAT" class="number"  size="20" value="${personInfo.PROB_PAY_RAT }"/>
			 ...
			 <div>
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
											...
											<tr>
												...
												<td class="td_type">${personInfo.NATIONALITY_CODE}
												</td>
												<td class="td_title">
												...
												<td class="td_type">
												<input type="radio" name="SEX" value="M" <c:if test="${personInfo.SEX_NAME eq '男' }">checked</c:if> />男
							                    <input type="radio" name="SEX" value="F" <c:if test="${personInfo.SEX_NAME eq '女' }">checked</c:if>/>女
												</td>
												<td class="td_title">
												...
												<td class="td_type">
													<input type="text" id="TEMP1_DOB" name="DOB" class="required date" format="yyyy-MM-dd" yearstart="-100" yearend="10" 
															size="10" value="${personInfo.DOB }"/>
												...
												<td class="td_type">
													<ait:SelectSyCodeByCpnyID name="FINAL_DEGREE_CODE" parentNo="211777" cnpyID="${defaultCpny}" limit="all" selected="${personInfo.FINAL_DEGREE_CODE}"/>
												</td>
											</tr>
											...
											<tr>
												...
												<td class="td_type">
														<input type="text" id="WEDD_DATE" name="WEDD_DATE" class="date" format="yyyy-MM-dd" yearstart="-100" yearend="10" 
																	size="10" value="${personInfo.WEDD_DATE }"/>
														<a class="inputDateButton"><spring:message code="public.title.choose" /><!-- 选择 --></a>
												</td>
												<td class="td_title">
												...
												<td class="td_type">
												<input type="text" id="TEMP1_IDCARD_NO" name="IDCARD_NO"  size="30" value="${personInfo.IDCARD_NO }"/>
												</td>
												<td class="td_title">
												...
												<td class="td_type">
													...
													size="20" value="${personInfo.ID_CARD_NO }"/>
												</td>
												<td class="td_title">
												...
												<td class="td_type">
													<input type="text" id="EMAIL" name="EMAIL"  size="20" value="${personInfo.EMAIL }"/>
												</td>
											</tr>
											<tr>
												<td class="td_title">
												...
												<td class="td_type">
												<input type="text" id="HOME_PHONE" name="HOME_PHONE"  size="20" value="${personInfo.HOME_PHONE}"/>
												</td>
												<td class="td_title">
												...
												<td class="td_type">
												<input type="text" id="OFFICE_PHONE" name="OFFICE_PHONE"  size="20" value="${personInfo.OFFICE_PHONE}"/>
												...
												<td class="td_type">
												<input type="text" id="CELLPHONE" name="CELLPHONE"  size="20" value="${personInfo.CELLPHONE }"/>
												</td>
												<td class="td_title">
												...
												<td class="td_type" width="15%">
													<ait:SelectNonSyCodeByCpnyID name="REG_TYPE_CODE" id="REG_TYPE_CODE"
					     								codeType="REG_TYPE_CODE" 
					     							selected="${personInfo.REG_TYPE_CODE }"
					     								cnpyID="${defaultCpny}" 
					     								 limit="all"
					     							/>
											...
											<tr>
												...
												<input type="text" id="HOME_ADDRESS" name="HOME_ADDRESS"  size="60" value="	${personInfo.HOME_ADDRESS }"/>
												</td>
												<td class="td_title">
													<spring:message
												...
												<td class="td_type">
												<input type="text" id="POSTALCODE" name="POSTALCODE"  size="20" value="${personInfo.POSTALCODE}"/>
												</td>
											</tr>
											<tr>
												<td class="td_title">
											...
											<tr>
												...
												<td class="td_type" width="15%">
													<%-- <input type="text" id="LEAVE_REASON" name="LEAVE_REASON"  size="50" value="${personInfo.LEAVE_REASON }"/> --%>
												</td>
												<td class="td_title">
													<%-- <spring:message
												...
												<td class="td_type" width="15%">
													<%-- <input type="text" id="REMARK" name="REMARK"  size="50" value="${personInfo.REMARK }"/> --%>
												</td>
											</tr>
										</table>
			</div>
			...
			<div>
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
										...
										<tr>
											...
											<td class="td_type">
												<%-- <ait:SelectNonSyCodeByCpnyID name="PAY_GRADE"  id="PAY_GRADE"
					     						codeType="PAY_GRADE" 
											...
											<td class="td_type">
													<%-- <ait:SelectNonSyCodeByCpnyID id="PAY_STEP" name="PAY_STEP"
					     							codeType="PAY_STEP" 
											...
											<td class="td_type">
												<input type="text" id="BASE_PAY" name="BASE_PAY" class="number" size="20" value="${personInfo.BASE_PAY }"/>
											</td>
											<td class="td_title">
											...
											<td class="td_type">
												<input type="text" id="VARB_PAY" name="VARB_PAY" class="number" size="20" value="${personInfo.VARB_PAY }"/>
											</td>
										</tr>
										<tr>
											<td class="td_title">
											...
											<td class="td_type">
											<input type="text" id="BANK_ID" name="BANK_ID"  size="20" value="${personInfo.BANK_ID }"/>
											</td>
											<td class="td_title">
											...
											<td class="td_type">
												<input type="text" id="CARD_NAME" name="CARD_NAME"  size="30" value="${personInfo.CARD_NAME}"/>
											</td>
											<td class="td_title">
											...
											<td class="td_type">
												<input type="text" id="CARD_NO" name="CARD_NO" class="number" size="20" value="${personInfo.CARD_NO}"/>
											</td>
										</tr>
										<%-- <tr>
											<td class="td_title">
											...
											<td class="td_type">
												<input type="text" id="EXPNS_BANK_CD" name="EXPNS_BANK_CD"  size="20" value="${personInfo.EXPNS_BANK_CD }"/>
											</td>
											<td class="td_title">
												<spring:message
											...
											<td class="td_type">
												<input type="text" id="EXPNS_BANK_BRNCH_NM" name="EXPNS_BANK_BRNCH_NM"  size="30" value="${personInfo.EXPNS_BANK_BRNCH_NM }"/>
											</td>
											<td class="td_title">
											...
											<td class="td_type" width="8%">
												<input type="text" id="EXPNS_BANK_ACCT_NO" name="EXPNS_BANK_ACCT_NO"  size="20" value="${personInfo.EXPNS_BANK_ACCT_NO}"/>
											</td>
											<td class="td_title">
											</td>
											<td class="td_type">
										...
										<tr>
											...
											<td class="td_type"><%-- ${personInfo.IF_PAYMENT_EDUCATION_NAME } --%>
											</td>
											<td class="td_title">
											</td>
											<td class="td_type" >
								...
								<div>
									<table width="100%" border="0" cellpadding="0" cellspacing="0"
										...
										<tr>
											...
											<td class="td_type">
												<ait:SelectNonSyCodeByCpnyID name="SHIFT_NO" id="SHIFT_NO"
					     								codeType="SHIFT_NO" 
					     							selected="${personInfo.SHIFT_NO }"
					     								cnpyID="${defaultCpny}"  disabled="disabled"/>
					     						<input type="hidden" id="SHIFT_NO" name="SHIFT_NO" value="${personInfo.SHIFT_NO}" > 
											   </td>
										...
										<tr>
											...
											<td class="td_type"><ait:SelectSyCodeByCpnyID id="EMP_TYPE_CODE" name="EMP_TYPE_CODE" parentNo="1368" selected="${personInfo.EMP_TYPE_CODE}" cnpyID="${defaultCpny}" limit="all" disabled="true"/>
											...
											<td class="td_type">
												<ait:ComboSyCodeDescByCpnyID name="JOB_TITLE_CD"
													...
													selected="${personInfo.JOB_TITLE_CD}"
													cnpyID="${defaultCpny}"/> 
												<%-- <input type="text" id="EMP_TYPE_START_DATE" name="EMP_TYPE_START_DATE"  format="yyyy-MM-dd" yearstart="-100" yearend="10" 
															size="10" value="${personInfo.EMP_TYPE_START_DATE }" readonly="readonly" />
												<a class="inputDateButton"><spring:message code="public.title.choose" /><!-- 选择 --></a> --%>
											</td>
											<td class=td_title>福利地区(公积金)</td>
											<td class="td_type">
		 										<ait:SelectSyCodeByCpnyID id="INSRAREA_ID_INS" name="INSRAREA_ID_INS" parentNo="216736" selected="${personInfo.INSRAREA_ID_INS}" cnpyID="${defaultCpny}" limit="all"/>
											 </td>
											<td class="td_type">
		 										<ait:SelectState id="seach_STATENM_viewEduPerInfo" name="seach_STATENM_viewEduPerInfo" type="STATE" parentNo="" selected="${STATENM}" limit="all"/>
										...
										<tr>
											...
											<td class="td_type" width="15%">
													<input type="text" id="OUTER_WORK_YEAR" name="OUTER_WORK_YEAR" class="number" size="20" value="${personInfo.OUTER_WORK_YEAR }"/>
													<spring:message
													code="hr.viewPersonalInfo.title.tishixinxi.zaiwaigongling" />
											</td>
											<td class=td_title>福利地区(保险)</td>
											<td class="td_type">
		 										<ait:SelectSyCodeByCpnyID id="INSRAREA_ID" name="INSRAREA_ID" parentNo="216736" selected="${personInfo.INSRAREA_ID}" cnpyID="${defaultCpny}" limit="all"/>
											 </td>
										</tr>
										<tr>
											<td class="td_title">
										...
										<tr>
											...
											<td class="td_type" >${personInfo.EVS_TYPE_NAME }
											</td> --%>
	...
	<div class="formBar">
			<ul>
				<li><div class="buttonActive"><div class="buttonContent"><button type="submit" onClick="return isIdCardNo();"><spring:message code="public.title.submit"/><!-- 保存 --></button></div></div></li>
				<li>
