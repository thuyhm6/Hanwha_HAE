...
<div class="pageContent">
	<form method="post" action="/hrm/empinfo/deleteFamilyInfo" class="pageForm required-validate" onsubmit="return validateCallbackDeleteFamilyInfo(this, dialogAjaxDone);">
