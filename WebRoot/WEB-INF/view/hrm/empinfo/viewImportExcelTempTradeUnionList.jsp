...
<div class="pageHeader">
	<form id="viewEvalDataExcelImportResult" name="viewEvalDataExcelImportResult"
			action="/hrm/empinfo/viewImportExcelTempTradeUnionList" 
...
<div class="pageContent">	
	...
	<div class="formBar">
		<ul>			
			...
			href="/hrm/empinfo/downloadWorkExperienceExcelTemplateByExcelData?type=trade"><span>
			...
			href="/hrm/empinfo/submitImportExcelWorkExperienceData?accrual=trade"  title="确定要提交吗?"><span>
		...
		<tbody>
			<c:forEach items="${itemList}" var="item" varStatus="i">			
				<tr>
					...
					<td class='td_center'>${item.RESPONSIBITITY}</td>
					<td class='td_center'>${item.ADDDATE}</td>
					<td class='td_center'>${item.QUITDATE}</td>
					<td class='td_center'>${item.PAY_FLAG}</td>
					<td class='td_center'>${item.PAY_TYPE}</td>
	...
	<c:set value="/hrm/empinfo/viewImportExcelTempTradeUnionList" var="pageUrl"/>
