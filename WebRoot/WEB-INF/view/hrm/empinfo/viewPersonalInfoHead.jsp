...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td class="user_photo">
				...
				<a id="photoHref" name="photoHref"  href="#" target="dialog" mask="true"  title="上传照片" ></a>
				
				<%--<input type="button" onclick="photoShow(${personInfo.EMPID},${personInfo.PERSON_ID})" value="上传照片" /> --%>
				
				
				<%--<input type="button" onclick="photoShow('${personInfo.EMPID}','${personInfo.PERSON_ID}','${personInfo.CPNY_ID}')" value="上传照片" /> --%>
