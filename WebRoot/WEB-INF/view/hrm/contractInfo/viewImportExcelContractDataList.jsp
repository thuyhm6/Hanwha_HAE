...
<div class="pageContent">	
	...
	<div class="formBar">
		<ul>			
			<li><a class="buttonActive" onclick="importExcelNoContract()"> <span><spring:message
			...
			href="/hrm/contractInfo/submitImportExcelContractData"  title="确定要提交吗?"><span>
	...
	<table class="table" width="100%" layoutH="220" nowrapTD="false">
		<thead>
			<tr>
				...
				<th><!-- 备注 --><spring:message code="hrm.empinfo.REMARK" />   </th>
