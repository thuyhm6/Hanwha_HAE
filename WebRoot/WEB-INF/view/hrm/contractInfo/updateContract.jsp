...
function validateCallbackUpdateContract(form, callback) {
 ...
 <div class="pageContent">
     <form id="updateContract" method="post" action="/hrm/contractInfo/updateContractInfo" class="pageForm required-validate" 
     	onsubmit="return validateCallbackUpdateContract(this, dialogAjaxDone);">
		<div class="pageFormContent nowrap">   
		    ...
		    <dl>
				...
				<dd>
                    ...
                    <%--
					<ait:selectSyCode name="CONTRACT_TYPE_CODE" selected="${contract.CONTRACT_TYPE_CODE }" parentNo="1649" />
                     --%>
					<input name="PERSON_ID" type="hidden" value="${contract.PERSON_ID }"/>
					<input name="CONTRACT_NO" type="hidden" value="${contract.CONTRACT_NO }"/>
				</dd>
			</dl>
		    ...
		    <dl>
				...
				<dd>
					<input type="text" id="START_CONTRACT_DATE" name="START_CONTRACT_DATE" value="${contract.START_CONTRACT_DATE }" class="date required" readonly="true"  />
				</dd>
			</dl>
			...
			<dl id="contractEndTime">
				...
				<dd>
					<input type="text" id="END_CONTRACT_DATE" name="END_CONTRACT_DATE" value="${contract.END_CONTRACT_DATE }" class="date" readonly="true"  />
				</dd>
			</dl>
			...
			<dl>
				...
				<dd>
					<textarea cols="100" rows="4" class="l-textarea" name="REMARK" id="REMARK" style="width:400px" class="required" maxlength="60">${contract.REMARK}</textarea>
				</dd>
			</dl>     
