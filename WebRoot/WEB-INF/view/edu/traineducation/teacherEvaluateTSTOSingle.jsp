...
<div class="pageContent" layoutH="10">
	<form method="post" id="teacherEvaluateInfo" action="/edu/traineducation/updateStudentEvaluateInfo" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone);">
		 ...
		 <div class="formBar" id="teakaopingTitle" style="">
			<ul>
					<li>
						<a class="buttonActive" href="/disc/autoExcel/exportLOtImportExcel?SQL_SEQMEAN=198&BASIC_NO=${teacherEvaluateInfo.BASIC_NO }&CPNY_ID=${LoginUser.cpnyId}">
		...
		<tr>
		<td class="td_title" width="5%" rowspan="2">NO.</td>
		<td class="td_title" width="1%" rowspan="2"><spring:message code="alert.pa.pasalarycanshu.shehao"/><!--社号--></td>
		...
		<%-- <td class="td_title" width="10%" rowspan="2"><spring:message code="hr.viewPersonalInfo.title.SEX"/><!--性别--></td> --%>
		...
		<td class="td_title" width="10%" colspan="6" style="text-align:center"><spring:message code="inct.salesman.eval.result"/><!--评价结果--></td>
		</tr>
		<tr>
		...
		<%-- <td class="td_type"  width="10%" style="text-align:center">${s.SEXCODE_NAME }</td> --%>
