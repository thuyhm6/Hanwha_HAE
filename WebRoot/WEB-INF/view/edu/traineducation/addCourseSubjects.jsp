...
<div class="pageContent" layoutH="10">
	<form method="post" action="/edu/traineducation/addCourseSubjectsInfo" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone);">
		<div class="formBar">
			<ul>
		...
		<input type="text"  name="SUBJECT_NO" id="SUBJECT_NO" value="">
		</td>
		</tr>
		<tr>
		<td class="td_title" width="1%"><spring:message code="edu.studentEvaluate.SUBJECT_NAME.a"/> <!--主题名称--></td>
		<td class="td_type"  width="20%">
		<input size="100" type="text"  name="SUBJECT_NAME" id="SUBJECT_NAME" value="">
		</td>
		</tr>
		<tr >
