	...
	<form method="post" id="teacherEvaluateInfo" action="/edu/traineducation/updateStudentEvaluateInfo" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone);">
		 ...
		 <div class="formBar" id="teakaopingTitle" style="">
			<ul>
				...
				<!-- <li onclick="teacherEvabaocun()"><div class="buttonActive"><div class="buttonContent">保存</div></div></li> -->
		...
		<tr>
		<td class="td_title" width="10%"><spring:message code="alert.pa.pasalarycanshu.xingming"/><!--姓名--></td>
		<td class="td_title" width="10%"><spring:message code="hr.viewCondSql.title.ZHIJI"/><!--职级--></td>
		<td class="td_title" width="10%"><spring:message code="hr.viewPersonalInfo.title.DEPTNAME"/><!--部门--></td>
		<td class="td_title" width="10%"><spring:message code="hr.viewPersonalInfo.title.SEX"/><!--性别--></td>
		<td class="td_title" width="10%"><spring:message code="inct.salesman.position"/><!--职务--></td>
		<td class="td_title" width="40%"  style="text-align:center">&nbsp&nbsp&nbsp<spring:message code="edu.teacherEvaluate.XUEYUANKAOPING.a"/><!--学员考评-->&nbsp&nbsp&nbsp</td>
		...
		<td class="td_type"  width="10%">${s.POST_GRADE_NO_NAME }</td>
		<td class="td_type"  width="10%">${s.ORG_NAME_LOCAL }</td>
		<td class="td_type"  width="10%">${s.SEXCODE_NAME }</td>
		...
		<c:if test="${s.ALLSCORE==null }">
		<a id="weikao_${s.TEA_EMPID }" href="/edu/traineducation/teacherKaoping?CHECK_NO=${s.CHECK_NO }&BASIC_NO=${s.BASIC_NO}" id="kaoping" rel="kao" target="dialog" mask="true" width="600" height="400" >
		<span id="weikaoping_${s.TEA_EMPID }"><spring:message code="edu.teacherEvaluate.WEIKAOPING.a"/><!--未考评--></span></a>
		</c:if>
		<c:if test="${s.ALLSCORE!=null }">
		<a style="color:red;" href="/edu/traineducation/teacherKaoping?CHECK_NO=${s.CHECK_NO }&BASIC_NO=${s.BASIC_NO}" id="kaoping" rel="kao" target="dialog" mask="true" width="600" height="400" >
