    ...
    <td>
    	<table width="45%" border="2" align="center" cellpadding="0" cellspacing="0" 
			...
			<tr>
				...
				<th width="4%" align="center"><spring:message code="ar.excelexport.title.month"/><!--月份--></th>
				...
				<th width="4%" align="center"><spring:message code="hrm.empinfo.Training_form"/><!--培训形式--></th>
