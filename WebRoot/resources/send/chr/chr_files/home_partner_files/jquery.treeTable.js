...
(function ($) {
	...
	if (document.location.href.indexOf('http://') != 0)	{
		...
		var path = SITE_URL + '/resources/js/jquery';
	}
	path = ""
    $.fn.treeTable = function (opts) {
        ...
        if ($('head').find('#tree_table_' + opts.theme).length == 0) {
            $('head').append('<link id="tree_table_' + opts.theme + '" href="/resources/js/jquery/default/jquery.treeTable.css" rel="stylesheet" type="text/css" />');
        }
