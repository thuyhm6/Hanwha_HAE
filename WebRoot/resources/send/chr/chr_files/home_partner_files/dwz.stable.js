...
(function($){
	$.fn.jTable = function(options){
		return this.each(function(){
			...
			var $ftrs = tbody.find('>tr:even');
			for (var i=0; i < $ftrs.size(); i++) {
					var $ftddd = $($ftrs[i]);
					$ftddd.addClass("trbga");
				}
			...
			function _resizeGrid(){
				$("div.j-resizeGrid").each(function(){
					...
					if(height){
						...
						//var pageHeader_height = $(this).prev("div.pageHeader") ? $(this).prev("div.pageHeader").height() : 0;
						var gridHeader_height = $("div.gridHeader", this) ? $("div.gridHeader", this).height() : 0;
						var panelBar_height = $("div.panelBar", this) ? $("div.panelBar", this).height() : 0;
						//alert("height==="+height);
						//alert("pageHeader_height==="+pageHeader_height);
						//alert("gridHeader_height==="+gridHeader_height);
						//alert("panelBar_height==="+panelBar_height);
						height = height - gridHeader_height - panelBar_height;
						//alert("height==="+height);
