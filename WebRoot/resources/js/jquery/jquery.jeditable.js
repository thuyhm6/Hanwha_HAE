        ...
        types: {
            ...
            date: {
                element : function(settings, original) {
            		...
            		var input = $('<input type="text" class="Wdate" onkeydown="javascript:if(event.keyCode == 13)$(this).blur();" onClick="select();WdatePicker({dateFmt:\'' + format + '\',onpicked:jeditableDate,lang:\'' + lang + '\'});"/>');
                    if (settings.width  != 'none') { input.width(settings.width);  }
                    input.attr('autocomplete','off');
                    $(this).append(input);
                    return(input);
            ...
            date1: {
                element : function(settings, original) {
            		...
            		var input = $('<input type="text" class="Wdate required" readonly="true" onkeydown="javascript:if(event.keyCode == 13)$(this).blur();" onFocus="select();WdatePicker({dateFmt:\'' + format + '\',onpicked:jeditableDate,lang:\'' + lang + '\'});"/>');
                    if (settings.width  != 'none') { input.width(settings.width);  }
                    input.attr('autocomplete','off');
                    $(this).append(input);
                    return(input);
