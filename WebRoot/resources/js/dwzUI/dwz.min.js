...
var op=$.extend({container:"#container",collapse:".collapse",toggleBut:".toggleCollapse div",leftside:"#leftside",leftside2:"#leftside_s",splitBar:"#splitBar",splitBar2:"#splitBarProxy"},options);
return this.each(function(){
var jbar=this;
var sbar=$(op.leftside2,jbar);
var bar=$(op.leftside,jbar);
...
spbar2.jDrag($.extend(options,{obj:$("#leftside"),move:"horizontal",event:event,stop:function(){
...
function initLayout(){
var iContentW=$(window).width()-(DWZ.ui.sbar?$("#leftside").width()+10:34)-5;
var iContentH=$(window).height()-$("#header").height()-34;
$("#container").width(iContentW);
$("#container .tabsPageContent").height(iContentH-34).find("[layoutH]").layoutH();
$("#leftside, #leftside_s .collapse, #splitBar, #splitBarProxy").height(iContentH-5);
...
$("#leftside").find(".accordion").remove().end().append(html).initUI();
