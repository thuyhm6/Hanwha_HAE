...
function initLayout(){
	var iContentW = $(window).width() - (DWZ.ui.sbar ? $("#leftside").width() + 0 : 10) - 1;
	var iContentH = $(window).height() - $("#header").height() - $("#footer").height();
	//alert(iContentH);
	//$("#container").width(iContentW);
	$("#container .tabsPageContent").height(iContentH-30).find("[layoutH]").layoutH();
	$("#splitBar, #splitBarProxy").height(iContentH+1);
